...
public class Risposta_invioSAP_TypeEsito implements java.io.Serializable {
    ...
    public static Risposta_invioSAP_TypeEsito fromValue(java.lang.String value)
        ...
        Risposta_invioSAP_TypeEsito enumeration = (Risposta_invioSAP_TypeEsito)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Risposta_invioSAP_TypeEsito.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", ">risposta_invioSAP_Type>Esito"));
    }
    /**
