...
public class Risposta_checkUtenteYG_TypeEsito implements java.io.Serializable {
    ...
    public static Risposta_checkUtenteYG_TypeEsito fromValue(java.lang.String value)
        ...
        Risposta_checkUtenteYG_TypeEsito enumeration = (Risposta_checkUtenteYG_TypeEsito)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Risposta_checkUtenteYG_TypeEsito.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", ">risposta_checkUtenteYG_Type>Esito"));
    }
    /**
