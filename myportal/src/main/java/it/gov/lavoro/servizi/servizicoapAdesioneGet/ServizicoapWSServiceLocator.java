...
public class ServizicoapWSServiceLocator extends org.apache.axis.client.Service implements it.gov.lavoro.servizi.servizicoapAdesioneGet.ServizicoapWSService {
    ...
    public ServizicoapWSServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for servizicoapWS
    private java.lang.String servizicoapWS_address = "";
    ...
    public it.gov.lavoro.servizi.servizicoapAdesioneGet.ServizicoapWS getservizicoapWS() throws javax.xml.rpc.ServiceException {
    ...
    public it.gov.lavoro.servizi.servizicoapAdesioneGet.ServizicoapWS getservizicoapWS(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.gov.lavoro.servizi.servizicoapAdesioneGet.ServizicoapWSSoapBindingStub _stub = new it.gov.lavoro.servizi.servizicoapAdesioneGet.ServizicoapWSSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.gov.lavoro.servizi.servizicoapAdesioneGet.ServizicoapWS.class.isAssignableFrom(serviceEndpointInterface)) {
                it.gov.lavoro.servizi.servizicoapAdesioneGet.ServizicoapWSSoapBindingStub _stub = new it.gov.lavoro.servizi.servizicoapAdesioneGet.ServizicoapWSSoapBindingStub(new java.net.URL(servizicoapWS_address), this);
                _stub.setPortName(getservizicoapWSWSDDServiceName());
                return _stub;
            }
        }
