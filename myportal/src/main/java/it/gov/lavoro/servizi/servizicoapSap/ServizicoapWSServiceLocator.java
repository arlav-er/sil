...
public class ServizicoapWSServiceLocator extends org.apache.axis.client.Service implements it.gov.lavoro.servizi.servizicoapSap.ServizicoapWSService {
    ...
    public it.gov.lavoro.servizi.servizicoapSap.ServizicoapWS getservizicoapWS() throws javax.xml.rpc.ServiceException {
    ...
    public it.gov.lavoro.servizi.servizicoapSap.ServizicoapWS getservizicoapWS(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.gov.lavoro.servizi.servizicoapSap.ServizicoapWSSoapBindingStub _stub = new it.gov.lavoro.servizi.servizicoapSap.ServizicoapWSSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.gov.lavoro.servizi.servizicoapSap.ServizicoapWS.class.isAssignableFrom(serviceEndpointInterface)) {
                it.gov.lavoro.servizi.servizicoapSap.ServizicoapWSSoapBindingStub _stub = new it.gov.lavoro.servizi.servizicoapSap.ServizicoapWSSoapBindingStub(new java.net.URL(servizicoapWS_address), this);
                _stub.setPortName(getservizicoapWSWSDDServiceName());
                return _stub;
            }
        }
