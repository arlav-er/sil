...
public class Applicazione implements java.io.Serializable {
    ...
    public static Applicazione fromValue(java.lang.String value)
          throws java.lang.IllegalArgumentException {
        Applicazione enumeration = (Applicazione)
            _table_.get(value);
        if (enumeration==null) throw new java.lang.IllegalArgumentException();
        return enumeration;
    }
    public static Applicazione fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Applicazione.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://anpal.gov.it/DataModels/InformationDelivery/ConferimentoDID/1.0", "Applicazione"));
    }
    /**
