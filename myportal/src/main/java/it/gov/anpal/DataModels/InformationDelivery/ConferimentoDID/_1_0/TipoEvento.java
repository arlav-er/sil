...
public class TipoEvento implements java.io.Serializable {
    ...
    public static TipoEvento fromValue(java.lang.String value)
          throws java.lang.IllegalArgumentException {
        TipoEvento enumeration = (TipoEvento)
            _table_.get(value);
        if (enumeration==null) throw new java.lang.IllegalArgumentException();
        return enumeration;
    }
    public static TipoEvento fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TipoEvento.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://anpal.gov.it/DataModels/InformationDelivery/ConferimentoDID/1.0", "TipoEvento"));
    }
    /**
