...
public class ServiceMyPortalLocator extends org.apache.axis.client.Service implements it.eng.sare.secure.services.ServiceMyPortal {
    ...
    public ServiceMyPortalLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public it.eng.sare.secure.services.ServiceMyPortalSoap getServiceMyPortalSoap() throws javax.xml.rpc.ServiceException {
    ...
    public it.eng.sare.secure.services.ServiceMyPortalSoap getServiceMyPortalSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.eng.sare.secure.services.ServiceMyPortalSoapStub _stub = new it.eng.sare.secure.services.ServiceMyPortalSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.eng.sare.secure.services.ServiceMyPortalSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                it.eng.sare.secure.services.ServiceMyPortalSoapStub _stub = new it.eng.sare.secure.services.ServiceMyPortalSoapStub(new java.net.URL(ServiceMyPortalSoap_address), this);
                _stub.setPortName(getServiceMyPortalSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://regione.emilia-romagna.it/sare/secure/services/", "ServiceMyPortal");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://regione.emilia-romagna.it/sare/secure/services/", "ServiceMyPortalSoap"));
        }
