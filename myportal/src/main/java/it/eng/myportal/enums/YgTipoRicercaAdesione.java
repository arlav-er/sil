 ...
 */
public enum YgTipoRicercaAdesione {
	
	INIZIA_PER("Inizia per"), ESATTA("Esatta"),  CONTIENE("Contiene");
	
	private static List<SelectItem> tipiRicerca;
	private String label;

	private YgTipoRicercaAdesione(String label) {
		this.label = label;
	}
	...
	static {
		...
		for (YgTipoRicercaAdesione tipo : YgTipoRicercaAdesione.values()) {
