...
@ManagedBean
@ViewScoped
public class StampaPromemoriaCittOrientamentoBaseBean extends AbstractBaseBean {
	...
	public void cercaAppuntamenti() {
		...
		StampaPromemoriaCittOrientamentoBaseBean.SlotComparator slotComparator = new SlotComparator();
