...
@ManagedBean
@ViewScoped
public class EsitoAppuntamentoPatronatoBean extends AbstractBaseBean {
	...
	private void readParameters() {
		...
		try {
			...
			if (idAgAppuntamento != null) {
				appuntamentoPatronatoDTO = agAppuntamentoHome
						.findAppuntamentoDTObyIdAgAppuntamento(idAgAppuntamento);
			} else if (success) {
