...
@ManagedBean
@ViewScoped
public class TestataVacancyPfBean extends AbstractBaseBean {
	...
	public List<DeMansioneDTO> completeDeMansione(String query) {
		List<DeMansioneDTO> deMansiones =  deMansioneHome.findDTOByDescrizione(query);
		return deMansiones;
	}
