 ...
 *         iniziale deve essere precedente o uguale a quella finale
 * @author
 * 
 */
@FacesValidator(value = "twoDatesEqualOrLessValidator")
public class TwoDatesEqualOrLessValidator implements Validator {
