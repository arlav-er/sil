 ...
 * 
 */
@FacesValidator(value = "datesRangeValidatorVacancy")
public class DatesRangeValidatorVacancy implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) {
		...
		Date dataDaId = (Date) customComponent.getAttributes().get("data_da_id");
