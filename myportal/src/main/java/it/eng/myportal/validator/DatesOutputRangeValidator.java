 ...
 * 
 */
@FacesValidator(value = "datesOutputRangeValidator")
public class DatesOutputRangeValidator implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) {
		 ...
		 */
		HtmlOutputText htmlOutputText = (HtmlOutputText) view.findComponent(dataDaId);
		Date dataDa = null;
		if (htmlOutputText != null) {
			dataDa = (Date) htmlOutputText.getValue();
