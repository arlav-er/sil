 ...
 * 
 */
public class SpidAppSingleton extends HashMap<String, Map<String, String>> {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3705743854521397992L;

	protected static Log log = LogFactory.getLog(SpidAppSingleton.class);

	private static SpidAppSingleton instance = new SpidAppSingleton();

	public static SpidAppSingleton getInstance() {
		return instance;
	}

	private SpidAppSingleton() {
	}
