...
@WebServlet("/ICAR/VdaLogin")
public class IcarVdaLogin extends HttpServlet {

	protected static Log log = LogFactory.getLog(IcarVdaLogin.class);
...
//		}
		...
		try {
			log.info("URL di idm-vda:" + urlIcarInf3Servlet);
			resp.sendRedirect(urlIcarInf3Servlet );
		} catch (IOException e) {
			log.error("Errore nella redirezione ad IDM-VDA. URL=" + urlIcarInf3Servlet + " - errore: " + e.getMessage());
		}
