...
public class Ulterioriinformazioni {
     ...
     * This is why there is not a <CODE>set</CODE> method for the codalbo property.
     * 
     * <p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the codpatentino property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the codpatenteguida property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
