...
/**
 * <p>Classe Java per PattoAccettatoType complex type.
 * 
 ...
 *         &lt;element name="AccettazionePatto" type="{http://pattoonline.ws.myportal.eng.it/}AccettazionePattoType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "PattoAccettatoType", propOrder = {
    "patto",
    "accettazionePatto"
})
