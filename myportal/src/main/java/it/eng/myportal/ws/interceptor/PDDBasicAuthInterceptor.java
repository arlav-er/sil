...
public class PDDBasicAuthInterceptor extends AbstractPhaseInterceptor<Message> {

	public PDDBasicAuthInterceptor() {
		super(Phase.PRE_INVOKE);
		setCredentials();
	}

	public PDDBasicAuthInterceptor(String phase) {
		super(Phase.PRE_INVOKE);
	}
	...
	private void setCredentials() {
		abilitata = ConstantsSingleton.BasicAuthPDD.BASIC_AUTH_ABILITATA;
		username = ConstantsSingleton.BasicAuthPDD.BASIC_AUTH_USERNAME;
		password = ConstantsSingleton.BasicAuthPDD.BASIC_AUTH_PASSWORD;
		log.info("PDD Notifiche: Basic Authentication: abilitata=" + abilitata + " - Username=" + username
				+ " - Password=" + password);
	}
