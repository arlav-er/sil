...
public class AccettazionePattoType  implements java.io.Serializable {
    ...
    private it.eng.sil.coop.webservices.pattoonlinenew.AccettazionePattoTypeTipoAccettazione tipoAccettazione;

    public AccettazionePattoType() {
    }

    public AccettazionePattoType(
           java.util.Calendar dtmAccettazione,
           it.eng.sil.coop.webservices.pattoonlinenew.AccettazionePattoTypeTipoAccettazione tipoAccettazione) {
     ...
     */
    public it.eng.sil.coop.webservices.pattoonlinenew.AccettazionePattoTypeTipoAccettazione getTipoAccettazione() {
        return tipoAccettazione;
    }
     ...
     */
    public void setTipoAccettazione(it.eng.sil.coop.webservices.pattoonlinenew.AccettazionePattoTypeTipoAccettazione tipoAccettazione) {
        this.tipoAccettazione = tipoAccettazione;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AccettazionePattoType)) return false;
        ...
        _equals = true && 
            ((this.dtmAccettazione==null && other.getDtmAccettazione()==null) || 
             (this.dtmAccettazione!=null &&
              this.dtmAccettazione.equals(other.getDtmAccettazione()))) &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AccettazionePattoType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://pattoonlinenew.webservices.coop.sil.eng.it", "accettazionePattoType"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dtmAccettazione");
        elemField.setXmlName(new javax.xml.namespace.QName("http://pattoonlinenew.webservices.coop.sil.eng.it", "dtmAccettazione"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "dateTime"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("tipoAccettazione");
        elemField.setXmlName(new javax.xml.namespace.QName("http://pattoonlinenew.webservices.coop.sil.eng.it", "tipoAccettazione"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://pattoonlinenew.webservices.coop.sil.eng.it", ">accettazionePattoType>tipoAccettazione"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
