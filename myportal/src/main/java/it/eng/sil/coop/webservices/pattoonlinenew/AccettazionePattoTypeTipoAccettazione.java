...
public class AccettazionePattoTypeTipoAccettazione implements java.io.Serializable {
    ...
    public static AccettazionePattoTypeTipoAccettazione fromValue(java.lang.String value)
        ...
        AccettazionePattoTypeTipoAccettazione enumeration = (AccettazionePattoTypeTipoAccettazione)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AccettazionePattoTypeTipoAccettazione.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://pattoonlinenew.webservices.coop.sil.eng.it", ">accettazionePattoType>tipoAccettazione"));
    }
    /**
