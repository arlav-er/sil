...
(
  identificativosap character varying NOT NULL,
  risposta text,
  CONSTRAINT sap_pkey PRIMARY KEY (identificativosap)
)
WITH (
  OIDS=FALSE
);

ALTER TABLE ws_stub.sap
  OWNER TO sil;
...
(
  ...
  risposta text,
  CONSTRAINT did_pkey PRIMARY KEY (codicefiscale)
)
WITH (
  OIDS=FALSE
);

ALTER TABLE ws_stub.did
  OWNER TO sil;
...
insert into ws_stub.sap values (
'AA01711608H',
...
(
  codicefiscale character varying NOT NULL,
  statoadesione character varying NOT NULL,
  risposta text,
  CONSTRAINT adesione_yg_pkey PRIMARY KEY (codicefiscale)
)
WITH (
  OIDS=FALSE
);

ALTER TABLE ws_stub.adesione_yg
  OWNER TO sil;
...
(
  codice_identificativo character varying,
  denominazione character varying,
  misura character varying,
...
ALTER TABLE ws_stub.soggetti_accreditati
  OWNER TO sil;
