...
/**
 * Timer per fine sospensioni decreto 150
 * 
 * @author OMenghini
 *
 */
@Singleton
@Startup
@Named(FineSospensioneTimer.TIMER_NAME)
public class FineSospensioneTimer extends ConfigurableTimerBatch {

	static final String TIMER_NAME = "fineSospensioneTimer";
	private static final String CLASS_EXECUTE_BATCH = "it.eng.sil.util.batch.BatchFineSospensione";
