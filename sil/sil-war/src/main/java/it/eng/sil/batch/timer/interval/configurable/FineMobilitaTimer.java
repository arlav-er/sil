...
/**
 * Timer per la gestione della fine mobilità
 * 
 * @author OMenghini
 *
 */
@Singleton
@Startup
@Named(FineMobilitaTimer.TIMER_NAME)
public class FineMobilitaTimer extends ConfigurableTimerBatch {

	static final String TIMER_NAME = "fineMobilitaTimer";
	private static final String CLASS_EXECUTE_BATCH = "it.eng.sil.util.amministrazione.impatti.BatchFineMobilita";
	...
	public void sendMessage(Timer timer) throws Exception {
		...
		comando += " ancheTrattati true " + info.getBatchUserInfo();
