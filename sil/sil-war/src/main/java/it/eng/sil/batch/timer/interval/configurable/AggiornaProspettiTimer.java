...
/**
 * Timer per l'aggiornamento prospetti
 * 
 * @author OMenghini
 *
 */
@Singleton
@Startup
@Named(AggiornaProspettiTimer.TIMER_NAME)
public class AggiornaProspettiTimer extends ConfigurableTimerBatch {

	static final String TIMER_NAME = "aggiornaProspettiTimer";
	private static final String CLASS_EXECUTE_BATCH = "it.eng.sil.module.collocamentoMirato.BatchAggiornaProspetti";
