...
/**
 * Timer per la gestione della fine validità del Curriculm
 * 
 * @author OMenghini
 *
 */
@Singleton
@Startup
@Named(FineValiditaCurriculumTimer.TIMER_NAME)
public class FineValiditaCurriculumTimer extends ConfigurableTimerBatch {

	static final String TIMER_NAME = "fineValiditaCurriculumTimer";
	private static final String CLASS_EXECUTE_BATCH = "it.eng.sil.util.amministrazione.impatti.BatchFineValiditaCurriculum";
