...
/**
 * Timer per l'aggiornamento degli avvii a selezione consultando gli avviamenti nei movimenti
 * 
 * @author OMenghini
 *
 */
@Singleton
@Startup
@Named(AvvSelezioneTimer.TIMER_NAME)
public class AvvSelezioneTimer extends ConfigurableTimerBatch {

	static final String TIMER_NAME = "avvSelezioneTimer";
	private static final String CLASS_EXECUTE_BATCH = "it.eng.sil.util.batch.BatchAvvASelezioni";
	...
	public void sendMessage(Timer timer) throws Exception {
		...
		comando += " 12 " + info.getBatchUserInfo();
