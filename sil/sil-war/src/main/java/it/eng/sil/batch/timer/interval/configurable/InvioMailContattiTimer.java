...
/**
 * Timer per l'invio della mail ai contatti presenti in AG_CONTATTO
 * 
 * @author OMenghini
 *
 */
@Singleton
@Startup
@Named(InvioMailContattiTimer.TIMER_NAME)
public class InvioMailContattiTimer extends ConfigurableTimerBatch {

	static final String TIMER_NAME = "invioMailContattiTimer";
	private static final String CLASS_EXECUTE_BATCH = "it.eng.sil.util.batch.BatchInvioMailContatti";
