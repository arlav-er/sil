...
echo =============================================================== >> %log_err%
echo %timestamp% - ========= Avvio batch Creazione Script Migrazioni ========= >> %log_err%
...
SET class_name=it.eng.sil.util.batch.BatchScriptMigrazioni
...
%JAVA_HOME%\bin\java -cp .;%libs% %parameters% %class_name% InsertAM_MOVIMENTI_APPOGGIO.xml 00/00/0000 00/00/0000 XX E 100 %batch_user%
