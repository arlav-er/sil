:: BATCH DEPRECATO, DA ELIMINARE. IN SOSTITUZIONE REALIZZATO TIMER MovimentiGiornalieriTimer
@ECHO OFF
...
SET class_name=it.eng.sil.util.amministrazione.impatti.MovimentiGiornalieri
