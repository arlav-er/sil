:: BATCH DEPRECATO, DA ELIMINARE. IN SOSTITUZIONE REALIZZATO TIMER InizioValiditaCurriculumTimer
@ECHO OFF
...
SET parameters=-DAF_ROOT_PATH=..\.. -DAF_CONFIG_FILE=/WEB-INF/conf/master_batch_inizio_curriculum.xml -DCONTEXT_NAME=%context_name%
SET class_name=it.eng.sil.util.amministrazione.impatti.BatchInizioValiditaCurriculum
...
%JAVA_HOME%\bin\java -cp .;%libs% %parameters% %batch_launcher% %class_name%