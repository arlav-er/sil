:: BATCH DEPRECATO, DA ELIMINARE. IN SOSTITUZIONE REALIZZATO TIMER FineMobilitaTimer
@ECHO OFF
...
SET class_name=it.eng.sil.util.amministrazione.impatti.BatchFineMobilita
