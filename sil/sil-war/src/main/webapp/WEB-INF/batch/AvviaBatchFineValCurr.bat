:: BATCH DEPRECATO, DA ELIMINARE. IN SOSTITUZIONE REALIZZATO TIMER FineValiditaCurriculumTimer
@ECHO OFF
...
SET parameters=-DAF_ROOT_PATH=..\.. -DAF_CONFIG_FILE=/WEB-INF/conf/master_batch_fine_curriculum.xml -DCONTEXT_NAME=%context_name%
SET class_name=it.eng.sil.util.amministrazione.impatti.BatchFineValiditaCurriculum
