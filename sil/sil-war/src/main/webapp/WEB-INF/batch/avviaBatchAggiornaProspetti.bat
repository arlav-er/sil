:: BATCH DEPRECATO, DA ELIMINARE. IN SOSTITUZIONE REALIZZATO TIMER AggiornaProspettiTimer
@ECHO OFF
...
echo =============================================================== >> %log_err%
echo %timestamp% - ========= Avvio batch Aggiorna Prospetti  ========= >> %log_err%
...
SET class_name=it.eng.sil.module.collocamentoMirato.BatchAggiornaProspetti
