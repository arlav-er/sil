:: BATCH DEPRECATO, DA ELIMINARE. IN SOSTITUZIONE REALIZZATO TIMER avvSelezioneTimer
@ECHO OFF
...
echo =============================================================== >> %log_err%
echo %timestamp% - ========= Avvio batch di aggiornamento degli avvii a selezione ha restituito un dato errore ========= >> %log_err%
...
SET class_name=it.eng.sil.util.batch.BatchAvvASelezioni
...
%JAVA_HOME%\bin\java -cp .;%libs% %parameters% %class_name% 12 %batch_user%
