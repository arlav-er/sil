:: BATCH DEPRECATO, DA ELIMINARE. IN SOSTITUZIONE REALIZZATO TIMER CessazioniGiornaliereTimer
@ECHO OFF
...
SET class_name=it.eng.sil.util.amministrazione.impatti.CessazioniGiornaliere
...
%JAVA_HOME%\bin\java -cp .;%libs% %parameters% %class_name% nonTrattati true %batch_user%
