:: BATCH DEPRECATO, DA ELIMINARE. IN SOSTITUZIONE REALIZZATO TIMER ChiusuraCmSupEtaTimer
@ECHO OFF
...
SET class_name=it.eng.sil.util.batch.BatchChiusuraCmSuperamentoEta
...
%JAVA_HOME%\bin\java -cp .;%libs% %parameters% %class_name% 00/00/0000 %batch_user%
