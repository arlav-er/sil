:: BATCH DEPRECATO, DA ELIMINARE. IN SOSTITUZIONE REALIZZATO TIMER FineSospensioneTimer
@ECHO OFF
...
echo =============================================================== >> %log_err%
echo %timestamp% - ========= Avvio batch Fine Sospensione ========= >> %log_err%
...
SET class_name=it.eng.sil.util.batch.BatchFineSospensione
...
%JAVA_HOME%\bin\java -cp .;%libs% %parameters% %class_name% ancheTrattati true %batch_user%
