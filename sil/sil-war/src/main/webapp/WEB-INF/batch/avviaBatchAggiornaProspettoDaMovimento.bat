:: BATCH DEPRECATO, DA ELIMINARE. IN SOSTITUZIONE REALIZZATO TIMER AggiornaProspettoDaMovimentoTimer
@ECHO OFF
...
echo =============================================================== >> %log_err%
echo %timestamp% - ========= Avvio batch Aggiorna Prospetti da movimento ========= >> %log_err%
...
SET parameters=-DAF_ROOT_PATH=..\.. -DAF_CONFIG_FILE=/WEB-INF/conf/master_batch_aggiorna_prospetti.xml -DCONTEXT_NAME=%context_name%
SET class_name=it.eng.sil.module.collocamentoMirato.BatchAggiornaProspettoDaMovimento
