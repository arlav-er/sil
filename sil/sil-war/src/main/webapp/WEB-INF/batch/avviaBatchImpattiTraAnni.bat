:: BATCH DEPRECATO, DA ELIMINARE. IN SOSTITUZIONE REALIZZATO TIMER ImpattiTraAnniTimer
@ECHO OFF
...
SET class_name=it.eng.sil.util.amministrazione.impatti.BatchImpattiTraAnni
...
%JAVA_HOME%\bin\java -cp .;%libs% %parameters% %class_name% nonTrattati true %batch_user% false