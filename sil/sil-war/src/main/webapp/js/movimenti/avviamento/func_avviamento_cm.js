...
function controllaConvenzione() {
	if(document.Frm1.flagL68.checked){
		if (document.Frm1.datConvenzione.value=='' || document.Frm1.numConvenzione.value=='' ) {
			alert("I campi Nulla Osta/Conv. Num. e Data devono essere entrambi valorizzati.");
			return false;
		}
	}
	return true;
...
function abilitazioneConvenzione() {
	...
	var numConv = document.Frm1.numConvenzione.value;
	var datConv = document.Frm1.datConvenzione.value;
	
	if(numConv=="" && datConv==""){
		document.Frm1.numConvenzione.readonly=!abilita;
		document.Frm1.numConvenzione.disabled=!abilita;
		document.Frm1.datConvenzione.readonly=!abilita;
		document.Frm1.datConvenzione.disabled=!abilita;
		document.Frm1.bottoneConvenzione.readonly=!abilita;
		document.Frm1.bottoneConvenzione.disabled=!abilita;
	}
	if(abilita){
		if(document.Frm1.flagL68.checked){
			document.Frm1.bottoneConvenzione.className="pulsanti";
			document.Frm1.numConvenzione.className="inputEdit";
			document.Frm1.datConvenzione.className="inputEdit";
		...
		if(document.Frm1.flagL68.checked) {
			...
			if(numConv=="" && datConv==""){
				...
				document.Frm1.bottoneConvenzione.className="pulsantiDisabled";
			}
			else document.Frm1.FLGLEGGE68.value="S";
		}
	}
	
	if(!document.Frm1.flagL68.checked) {
			document.Frm1.numConvenzione.readonly=true;
			document.Frm1.numConvenzione.disabled=true;
			document.Frm1.datConvenzione.readonly=true;
			document.Frm1.datConvenzione.disabled=true;
			document.Frm1.bottoneConvenzione.readonly=true;
			document.Frm1.bottoneConvenzione.disabled=true;
			document.Frm1.numConvenzione.value="";
			document.Frm1.datConvenzione.value="";
			document.Frm1.bottoneConvenzione.className="pulsantiDisabled";
			document.Frm1.numConvenzione.className="viewRiepilogo";
