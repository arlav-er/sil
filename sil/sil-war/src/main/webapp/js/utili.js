...
function pattoOnClick()
{
	...
	t="dati";
	open(f,t);
	//parent.frames[0].str_percorso.innerHTML="accordo lavoratore&nbsp;>&nbsp;<b>patto 150</b>";
	var str=rif_percorso();
	str.innerHTML="preselezione&nbsp;&gt;&nbsp;accordo lavoratore&nbsp;&gt;&nbsp;<b>patto 150</b>";
}
