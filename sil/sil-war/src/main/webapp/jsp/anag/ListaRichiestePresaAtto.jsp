...
<%
	String  titolo = "Lista richieste presa atto";
	...
	if (cdnLavoratore!=null) {		// ho profilato solo la pagina di ricerca
		attributi = new PageAttribs(user, "RicercaRichiestePresaAttoPage");	
	}
%>
...
<script language="javascript">	
	...
	function goBackRicerca() {
		...
		var url = "AdapterHTTP?PAGE=RicercaRichiestePresaAttoPage" + "&cdnfunzione=<%=cdnfunzione%>";
...
<af:form dontValidate="true">
	...
	<af:list moduleName="M_LISTA_RICHIESTE_PRESA_ATTO" />
