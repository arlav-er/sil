...
<body class="gestione" onload="rinfresca()">
	...
	//Linguette l = new Linguette(user, _funzione, "CMFattoriAmbPage", new BigDecimal(cdnLavoratore));
	//Linguette_Parametro l = new Linguette_Parametro(user, _funzione, "CMFattoriAmbPage", cdnLavoratore, "1", true);			
	LinguetteConfigurazioneRegione l = new LinguetteConfigurazioneRegione (user, _funzione, "CMFattoriAmbPage" , cdnLavoratore , "1", true , "LNDGNFNZ");	
	l.show(out);
    %>
	...
	<af:form method="POST" action="AdapterHTTP" name="Frm1" onSubmit="">
		...
		<input type="hidden" name="PAGE" value="CMFattoriAmbPage" />		
...
<%
		...
		if(readCodiciScaduti) {
			rows= serviceResponse.getAttributeAsVector("M_Load_Descr_Cap_FattoriAmb_Scad.ROWS.ROW");
		} else {
			rows= serviceResponse.getAttributeAsVector("M_Load_Descr_Cap_FattoriAmb.ROWS.ROW");
		}
%>
