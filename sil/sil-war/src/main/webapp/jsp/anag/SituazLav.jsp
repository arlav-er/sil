...
<body class="gestione" onload="rinfresca()">
	...
	//Linguette l = new Linguette(user, _funzione, "CMSituazLavPage", new BigDecimal(cdnLavoratore));
	//Linguette_Parametro l = new Linguette_Parametro(user, _funzione, "CMSituazLavPage", cdnLavoratore, "1", true);
	LinguetteConfigurazioneRegione l = new LinguetteConfigurazioneRegione (user, _funzione, "CMSituazLavPage" , cdnLavoratore , "1", true , "LNDGNFNZ");
	...
	<af:form method="POST" action="AdapterHTTP" name="Frm1" onSubmit="">
		...
		<input type="hidden" name="PAGE" value="CMSituazLavPage" />		
...
<%
		...
		if(readCodiciScaduti) {
			rows= serviceResponse.getAttributeAsVector("M_Load_Descr_Cap_SituazLav_Scad.ROWS.ROW");
		} else {
			rows= serviceResponse.getAttributeAsVector("M_Load_Descr_Cap_SituazLav.ROWS.ROW");
		}	    
%>
