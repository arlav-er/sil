...
<body class="gestione" onload="rinfresca();caricaArea('2')">
	...
	//Linguette l = new Linguette(user, _funzione, "CMLocomozionePage", new BigDecimal(cdnLavoratore));
	//Linguette_Parametro l = new Linguette_Parametro(user, _funzione, "CMLocomozionePage", cdnLavoratore, "1", true);
	LinguetteConfigurazioneRegione l = new LinguetteConfigurazioneRegione (user, _funzione, "CMLocomozionePage" , cdnLavoratore , "1", true , "LNDGNFNZ");
	...
	<af:form method="POST" action="AdapterHTTP" name="Frm1" onSubmit="">
		...
		<input type="hidden" name="PAGE" value="CMLocomozionePage" />		
...
<%
		...
		if(readCodiciScaduti) {
			rows= serviceResponse.getAttributeAsVector("M_Load_Descr_Cap_Locomozione_Scad.ROWS.ROW");
		} else {
		rows= serviceResponse.getAttributeAsVector("M_Load_Descr_Cap_Locomozione.ROWS.ROW");
		}	
%>
