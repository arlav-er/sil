...
<body class="gestione" onload="rinfresca()">
	...
	LinguetteConfigurazioneRegione l = new LinguetteConfigurazioneRegione (user, _funzione, "CMComunicazionePage" , cdnLavoratore , "1", true , "LNDGNFNZ");
	...
	<af:form method="POST" action="AdapterHTTP" name="Frm1">
		...
		<input type="hidden" name="PAGE" value="CMComunicazionePage" />		
...
<%
			...
			if(readCodiciScaduti) {
				rows= serviceResponse.getAttributeAsVector("M_Load_Descr_Cap_Comunicazione_Scad.ROWS.ROW");
			} else {
				rows= serviceResponse.getAttributeAsVector("M_Load_Descr_Cap_Comunicazione.ROWS.ROW");
			}
%>
