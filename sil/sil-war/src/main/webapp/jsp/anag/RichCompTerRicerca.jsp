...
<head>
     ...
     <script language="Javascript">
		 ...
		 function cercaRichiesta(esisteAz){
			...
			var datSospDa = document.Frm1.DATAINIZIOVALIDITA_DAL;
			var datSospA = document.Frm1.DATAINIZIOVALIDITA_AL;
			
			if(datSospDa.value != "" && datSospA.value!= ""){
    			if (compareDate(datSospDa.value,datSospA.value) >= 0) {
      				alert("La " + datSospA.title + " deve essere maggiore della " + datSospDa.title);
	    			return false;
	  			}
	  		}
	  		
 		    url = "AdapterHTTP?PAGE=CMRichComTerListaPage&fromRicerca=1";
		 ...
		 function nuovaRichiesta(){
			var url;
 		    url = "AdapterHTTP?PAGE=CMRichCTDettPage&fromRicerca=1&nuovaRichiesta=1";
 		    url = url + "&CDNFUNZIONE=<%=_funzione%>";
 		    url = url + "&prgAzienda=<%=prgAzienda%>";
			url = url + "&nuovo=true";
			url = url + "&salva=false";
			url = url + "&CODSTATOATTO=NP";
			url = url + "&CODSTATORICHIESTA=DA";
 		    url = url + "&goBackListPage=CMRichCompTerRicercaPage";
...
<body class="gestione" onload="rinfresca()">
  ...
  <p class="titolo">Ricerca richiesta di compensazione territoriale</p>
    <%out.print(htmlStreamTop);%>
	  <af:form method="POST" action="AdapterHTTP" name="Frm1" onSubmit="">
		  
		  <input type="hidden" name="prgAzienda" value="<%=prgAzienda%>" >
		  <input type="hidden" name="goBackListPage" value="CMRichCompTerRicercaPage" >
	      ...
	      <table class="main" border="0">
	        ...
	        <tr><td colspan="2">&nbsp;</td></tr>	        	        	        
			<tr>
			    <td class="etichetta">Stato della richiesta</td>
			    <td class="campo">
			      <af:comboBox title="Stato" name="CODSTATORICHIESTA" moduleName="M_COMBO_STATO_RICH_CT" addBlank="true" selectedValue=""/>&nbsp;
			    </td>
			<tr>
			<tr>
			    <td class="etichetta">Stato del documento</td>
			    <td class="campo">
			      <af:comboBox title="Stato" name="CODSTATOATTO" moduleName="COMBO_STATO_ATTO_RICH_CM_CT" addBlank="true" selectedValue=""/>
			    </td>
			<tr>
	        <tr>
	          <td class="etichetta">Data inizio validità&nbsp;dal</td>
	          <td class="campo">
	          	<af:textBox validateOnPost="true" type="date" name="DATAINIZIOVALIDITA_DAL" title="Data inizio validità dal" value="<%=DATAINIZIOVALIDITA_DAL%>" size="10" maxlength="10" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
