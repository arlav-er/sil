...
<%if (esitoOK){%>
	<META HTTP-EQUIV="Refresh" CONTENT="3;URL=AdapterHTTP?PAGE=framesetPage">
<%}%>
...
<br />
<p class="titolo">Cambio password</p>
...
<af:form method="POST" action="AdapterHTTP" name="Frm1"
	onSubmit="valida()">
	<af:textBox type="hidden" name="PAGE" value="cambioPwdSalvaPage" />
...
<p>Per continuare attendere qualche secondo oppure cliccare <a href="AdapterHTTP?PAGE=framesetPage">qui</a>
