...
<body class="gestione" onload="rinfresca();">
  ...
  <br/>
        ...
        <input type="hidden" name="PAGE" value="ListaProgrammiPage"/>
           ...
           <tr>
            <td colspan="2">
						...
						<table class="main" width="100%" border="0">
						    ...
						    <!-- <tr>
								<td class="etichetta">Codice Fiscale Lavoratore</td>
								<td class="campo"><af:textBox classNameBase="input"
										type="text" name="strcodiceFiscale"
										value="<%=strcodiceFiscale%>" size="50" maxlength="50" /></td>
							</tr>  -->
							<tr>
