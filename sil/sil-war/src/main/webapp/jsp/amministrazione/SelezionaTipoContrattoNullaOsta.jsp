...
<%  
    ...
    AbstractList assCompatibili = (AbstractList) serviceResponse.getAttributeAsVector("ListaTipoContrattoNullaOsta.ROWS.ROW");
...
<head>
  ...
  <title>Lista Tipi Assunzione</title>
   ...
   function riportaCodice(codice, descrizione,codmonotipo,codcontratto) {
   		  window.opener.<%=updateFunctionName%>(codice, descrizione,codmonotipo,codcontratto);
	      window.close();
      }

</script>
</head>
<body class="gestione" onload="<%=(oneAndOnly ? "riportaCodice('" + codice + "', '" + descrizione + "','" + codmonotipo + "','" + codcontratto + "');" : "")%>">

  <af:list moduleName="ListaTipoContrattoNullaOsta" jsSelect="riportaCodice"/>
