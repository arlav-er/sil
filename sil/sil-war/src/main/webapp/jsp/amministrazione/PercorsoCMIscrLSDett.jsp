...
<html>
  <head>
   ...
   <script language="Javascript">
	...
	function apriSezione(immagine, sezione) {
...
<%@ include file="../anag/_protocollazioneIscrListeSpeciali.inc" %>
...
<table style="border-collapse:collapse">
	...
	<tr>
		<td class="etichetta2">Operatore di riferimento SOOOOO</td>
        <td class="campo2" nowrap>
        	<af:comboBox classNameBase="input" onChange="fieldChanged();" name="PRGSPI"  moduleName="COMBO_SPI_SCAD" onChange="fieldChanged()" selectedValue="<%=PrgSpiStr%>"
 ...
 <% if(!nuovaIscrizione) {%>	
	<tr>
		<td colspan="4">
			<div class="sezione2">
		    	<img id='IMG1' src='<%=DATFINE.equals("") && CODMOTIVOFINEATTO.equals("")?img0:img1%>' onclick=''/>Chiusura/cancellazione
		  	</div>
	  	</td>
	</tr>
	<tr>
...
<script type="text/javascript">
	apriSezione(document.getElementById("IMG1"), document.getElementById("TBL1"));
</script>
