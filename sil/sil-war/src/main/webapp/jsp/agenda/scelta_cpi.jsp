...
<html>
<head>
  <title>Scelta Centro per l'Impiego</title>
...
<br>
<p class="titolo">Scelta Centro per l'Impiego</p>
<%out.print(htmlStreamTop);%>
<af:form action="AdapterHTTP" name="form" method="POST" >
...
<tr>
  ...
  <td class="campo">
   <af:comboBox name="CODCPI" title="Centro per l'Impiego competente" moduleName="M_GetCpiPoloProvinciale" addBlank="true" selectedValue="" required="true"/>
  </td>
</tr>
</table>
<br>
<span class="bottoni">
  <input class="pulsanti" type="submit" name="cambia" value="Cambia CPI"/>
  &nbsp;&nbsp;
</span>
</af:form>
...
<af:form name="formBack" action="AdapterHTTP" method="POST" dontValidate="true">
  ...
  <% if (codCpi!=null && !codCpi.equalsIgnoreCase("")) { %>
  <p align="center">  
