<!-- @author: Stefania Orioli - September 2003 -->
...
String strCognome = "";
String strNome = "";
String moduleName = "MGRUPPOLAV_POPUP";
...
<body class="gestione">
<br>
<h2>Lavoratori prenotati per l'appuntamento</h2>
...
<!--tr>
    ...
    Lavoratori prenotati per l'appuntamento
    </td>
</tr-->
<%
...
%>
    <tr>
    <th class="lista">Cognome</td>
    <th class="lista">Nome</td>
  </tr>
