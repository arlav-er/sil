...
<%
	...
	String docType = (String) serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.docType");
	String dataacqril = (String) serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.dataacqril");
	String oggetto = (String) serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.oggetto");
	String codicePAT = (String) serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.codicePAT");
	Documento documentoSil = (Documento) serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.documentoSIL");
	String descrizioneInvioPi3 = (String) serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.descrizioneInvioPi3");
	Object lstDocAllegatiObj = (Object) serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.lstDocAllegati");
	String descrizioneTipoProt = (String) serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.descrizioneTipoProt");
	String descrizioneTrattamento = (String) serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.DESCRIZIONETRATTAMENTO");
	
	String _protocollazionePi3 = (String) serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.PROTOCOLLAZIONE_PI3");
	String _protocollazionePi3Error = (String) serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.PROTOCOLLAZIONE_PI3_ERROR");
	
	String isPraticaAlreadyProcessed = (String) serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.isPraticaAlreadyProcessed");
	String numeroProtocollazione = (String)  serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.numeroProtocollo");
	String dataProtocollo = (String)  serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.dataProtocollo");
	String dataInvio = (String)  serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.dataInvio");
	String statoDocInviato = (String)  serviceResponse.getAttribute("M_GETINFOPROTOCOLLAZIONEPI3.statoDocInviato");
	...
	%>
		...
		<table class="main" border="0">
				...
				<tr>
					...
					<td class="campo">
						<af:textBox classNameBase="input" type="text" name="numeroProtocollo" value="<%=numeroProtocollazione%>" readonly="true" title="numeroProtocollo" size="31" />
					</td>
				</tr>
	  	...
	  	<input type="hidden" name="PAGE" value="Pi3HomePage">
