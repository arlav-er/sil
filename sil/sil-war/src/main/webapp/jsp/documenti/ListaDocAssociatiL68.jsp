...
<script language="javascript">
	...
	function tornaRicerca(){
		var url = "AdapterHTTP?PAGE=RicercaDocAssociatiL68Page" +
...
<%}%>
  ...
  <af:list moduleName="M_GetDocAssociatiL68"/>  		
...
<%
	...
	//^^^MAH...funzia per azienda e funzia ancora per lavorat?
%>
</script>
...
<table class="main" width="100%">
	<tr><td>
		<input type="button" value="Torna alla ricerca" class="pulsanti" onClick="tornaRicerca()" />
	</td></tr>
</table>
