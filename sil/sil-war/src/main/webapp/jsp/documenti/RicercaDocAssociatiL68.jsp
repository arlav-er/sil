...
<%
	...
	if (StringUtils.isFilled(infStoriche))
		titolo = "Ricerca informazioni storiche documenti L68";
	else if (StringUtils.isFilled(pagina))
		titolo = "Ricerca documenti L68 associati alla pagina";
	else
		titolo = "Ricerca documenti L68";
...
<input type="hidden" name="PAGE" value="ListaDocAssociatiL68Page" />
...
<table class="main">
	...
	<%-- ***************************************************************************** --%>
	<%@ include file="ProtocolloDocL68_Elemento.inc" %>
	<%-- ***************************************************************************** --%>
