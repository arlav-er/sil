...
Vector rows = sb.getAttributeAsVector("DE_IMPE_L.ROWS.ROW");
SourceBean row = null;
        ...
        <td>
            <table style="border-collapse:collapse" width="100%">
                <tr style="border: 1 solid #000080; color: #000080;  font-size: 12px;font-weight: normal;text-align: center;vertical-align:middle">
                    <td style="border: 1 solid;border-right: none"  align=center>Impegni del lavoratore</td>
...
%>            
                <tr>
                    <td width="25" height=25 valign=center>
                        <input type="checkbox" id="I_DE_IMPE_L<%=i%>">
                        <script>inputs.push(new Riga('DE_IMPE','DE_IMPE_L',<%=row.getAttribute("CODIMPEGNO").toString()%>,document.getElementById("I_DE_IMPE_L<%=i%>")));</script>
                    </td>
