...
//    pageContext.setAttribute("prgSection", BigInteger.ZERO);
    ///////////////////////////////
    Vector mansioniRows= serviceResponse.getAttributeAsVector("PattoElencoMansioniStorico.ROWS.ROW");
    ///////////////////////////////
    Vector elencoIndisponibilita = serviceResponse.getAttributeAsVector("PattoElencoIndisponibilitaStorico.ROWS.ROW");
    ///////////////////////////////
    ...
    ////////////////////////
    PageProperties pageProperties = new PageProperties("PattoAmbitoProfLinguettaPage",null);
    PageAttribs pageAttsPattoAperto = new PageAttribs(user, "PattoAmbitoProfLinguettaPage");
        ...
        <td colspan=3>
            <table width="100%">
                <tr>
                    ...
                    <td class="campo"><af:textArea onKeyUp="fieldChanged();" name="STRNOTEAMBITOPROF" value="<%=strNote%>" 
