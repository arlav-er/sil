...
<%
    ...
    /////////////////////////////////
    Vector impegni= serviceResponse.getAttributeAsVector("M_GETIMPEGNILEGATIALPATTO.ROWS.ROW");
        ...
        <td colspan=3>
            <table width="100%">
                <tr>
                    ...
                    <td class="campo"><af:textArea onKeyUp="javascript:fieldChanged();" name="STRNOTEIMPEGNI" value="<%=strNote%>" cols="60" rows="5" readonly="<%=readOnlyStr%>"/></td>
                    <td>
