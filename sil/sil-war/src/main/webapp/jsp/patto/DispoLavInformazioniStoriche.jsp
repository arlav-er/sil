...
<html>
<head>
<title>Informazione storiche dichiarazione disponibilita'</title>
...
<af:error/>
<%
    //Vector lista = (Vector)serviceResponse.getAttributeAsVector("M_DispoLavInformazioniStoriche.ROWS.ROW");
    //if (lista.size()>0) {
...
%>
<br>
<H2>Inf. storiche relative alle dich./conferme di immediata disponibilita' del lavoratore</H2>
<af:list moduleName="M_DispoLavInformazioniStoriche" canDelete="<%= canDelete ? \"1\" : \"0\" %>" />
</center>
