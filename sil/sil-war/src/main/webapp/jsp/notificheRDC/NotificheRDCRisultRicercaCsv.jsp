...
%><%
	...
	String filename = (responseBean != null && responseBean.getAttribute("M_NotificheRDCRicercaSaveCsv.fileExportRdcCsv") != null) ? 
			responseBean.getAttribute("M_NotificheRDCRicercaSaveCsv.fileExportRdcCsv").toString() : 
			"";
	String todayString = (new SimpleDateFormat("yyyyMMdd")).format(new Date());
	String outputFilename = "ListaNotificheRDC_" + todayString + ".csv";
