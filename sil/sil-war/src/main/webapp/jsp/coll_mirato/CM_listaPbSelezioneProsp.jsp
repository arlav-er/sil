...
function nuovo() {
	...
	var url = "AdapterHTTP?PAGE=CMPubblicaSelezionePage";		
	url += "&OPERAZIONE=NUOVO";
...
<center>
	<font color="green">
		<af:showMessages prefix="CMProspPbSelezioneSaveModule"/>
		<af:showMessages prefix="CMProspPbSelezioneUpdateModule"/>
		<af:showMessages prefix="CMProspPbSelezioneDeleteModule"/>
    </font>
</center>
<center>
...
<af:list moduleName="CMProspListPubSelezioneModule" canDelete="<%= canModify ? \"1\" : \"0\" %>" />
