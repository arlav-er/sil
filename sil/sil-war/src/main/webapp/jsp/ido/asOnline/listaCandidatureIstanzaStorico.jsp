...
String _page = "DettaglioScaricoIstanzePage";
...
String pageStorico = serviceRequest.getAttribute("PAGE_STORICO").toString(); 

String moduleStorico = serviceRequest.getAttribute("MODULE_STORICO").toString(); 
	 ...
	 <script language="Javascript">
	  ...
	  function tornaIndietro(){
	        ...
	        s += "&PRGINCROCIO=<%=prgIncrocio%>";  
		  	...
		  	s += "&numanno=<%=numAnno%>"; 
		  	s += "&TIPO=VISUALIZZA";
		  	s += "&PAGE_STORICO=<%=pageStorico%>";
		  	s += "&MODULE_STORICO=<%=moduleStorico%>";
