...
<%           	 	
	...
	SourceBean motivoApertura = (SourceBean) serviceResponse.getAttribute("CMGestRiapriGraduatorieModule.ROWS");
...
<input type="hidden" name="MODULE" value="CMRiapriGraduatoria">
