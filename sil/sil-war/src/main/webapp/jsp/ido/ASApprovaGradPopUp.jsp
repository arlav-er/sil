...
<%           	      	
	...
	SourceBean motivoApertura = (SourceBean) serviceResponse.getAttribute("ASGestApprovaGraduatorieModule.ROWS");
...
<font color="green"> 
 <af:showMessages prefix="ASSalvaApprovaGradModule"/>
</font>
...
<input type="hidden" name="PAGE" value="ASGestApprovaGraduatoriePage">
<input type="hidden" name="MODULE" value="ASSalvaApprovaGradModule">
