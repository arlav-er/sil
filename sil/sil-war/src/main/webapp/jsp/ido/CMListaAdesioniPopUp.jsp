...
<%         
    ...
    // POPUP EVIDENZE
	PageAttribs pageAtts = new PageAttribs((User) sessionContainer.getAttribute(User.USERID),"CMMatchDettGraduatoriaPage");    	
	int _funzione=0;
...
%>
	...
	<af:list moduleName="M_GetCMListaAdesioniLavoratoreView" skipNavigationButton="1"/>
