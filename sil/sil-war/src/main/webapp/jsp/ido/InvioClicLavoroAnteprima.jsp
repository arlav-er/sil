...
<%
	...
	String statoInvioClicLavoro = (String)serviceRequest.getAttribute("STATOINVIOCLICLAVORO");
		if(statoInvioClicLavoro.equals("PA")){
			...
			datiContatto = (SourceBean) serviceResponse.getAttribute("M_GetDatiContattoAnteprimaClicLavoro.ROWS.ROW");
		}	
	...
	//Dati Profilo
	SourceBean datiProfilo = (SourceBean) serviceResponse.getAttribute("M_GetDatiProfiliAnteprimaClicLavoro.ROWS.ROW");
	...
	String idComune = "", strDescrizione = "", idModalitaLavoro = "", nullaOsta = "";	
	if (datiCondizioniLavorative != null){
		...
		nullaOsta = StringUtils.getAttributeStrNotNull(datiCondizioniLavorative, "flgNullaOsta");
	}
	...
	//Dati Sistema
	SourceBean datiSistema = (SourceBean) serviceResponse.getAttribute("M_GetDatiSistemaAnteprimaClicLavoro.ROWS.ROW");
...
%>
	...
	<html>
	<head>
		<title>Anteprima invio richiesta di personale ClicLavoro</title>
		...
		<p class="titolo">Dati Relativi alla richiesta di personale</p>
			...
			<table class="main" border="0">
				<tr valign="bottom">
  				...
  				<tr>
  					<td class="etichetta">Nulla osta ai sensi dell'art.9 comma 8 del d.l. 76/2013</td>
  					<td class="campo2"><b><%= nullaOsta %></b></td>
  				</tr>
  			</table>
			<% out.print(htmlStreamBottom); %>	
