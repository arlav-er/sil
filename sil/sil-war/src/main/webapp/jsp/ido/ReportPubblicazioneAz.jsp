...
<html>
<head>
    <title>ReportPubblicazioneAz.jsp</title>
  ...
  <%@ include file="../documenti/_apriGestioneDoc.inc"%>
    ...
    function invio(nomeFile,utente){
      ...
      var numAnnoDal=document.form1.NUMANNODAL.value;
      var numAnnoAl=document.form1.NUMANNOAL.value;      
      var utric;
	  var macroqualifiche = "";
      ...
      apriGestioneDoc('RPT_PUBB_MAIN','&cdnLavoratore=<%=cdnLavoratore%>&DATPUBBLICAZIONEDAL=' + datDal + '&DATPUBBLICAZIONEAL=' + datAl + '&NUMPUBBLICAZIONEDAL=' + numDal + '&NUMPUBBLICAZIONEAL=' + numAl + '&NUMANNODAL=' + numAnnoDal + '&NUMANNOAL=' + numAnnoAl + '&UTRIC=' + utric + '&UTENTE=' + utric + '&CDNUT=' + utente + '&NOMEFILE=' + nomeFile+ macroqualifiche+'&modPubblicazione='+valore,'PUB_A');
...
<p class="titolo">Ricerca pubblicazioni per Aziende</p>
...
<tr>
  ...
  <td class="campo">
    ...
    <font type="etichetta">Al numero</font>
    <af:textBox type="integer" name="NUMPUBBLICAZIONEAL" title="Numero richiesta" value="" size="12" maxlength="10" validateOnPost="true" />
  </td>
</tr>

<tr>
  <td class="etichetta">Dall'anno</td>
  <td class="campo">
    <af:textBox type="integer" name="NUMANNODAL" title="Anno richiesta" value="" size="12" maxlength="10" validateOnPost="true" />
    <font type="etichetta">All'anno</font>    
    <af:textBox type="integer" name="NUMANNOAL" title="Anno richiesta" value="" size="12" maxlength="10" validateOnPost="true" />
  </td>
</tr>
...
<tr>
  <td colspan="2">
		 <center><input class="pulsante" type="button" onClick="javascript:invio('NewPubbl_az_CC.rpt','<%=codiceUtente%>')" name="btnReport" value="Stampa Azienda"/></center>
  </td>
</tr>
