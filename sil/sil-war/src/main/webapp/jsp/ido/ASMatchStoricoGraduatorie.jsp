...
PageAttribs attrGraduatorie = new PageAttribs(user, "ASStoricoGraduatoriePage");
...
<af:list moduleName="ASElencoStoricoGraduatorieModule"/>
...
<tr>
  <td align="center">
    <%
  	String parGraduatoria = "PAGE=ASGestGraduatoriePage&cdnFunzione="+_cdnFunzione+"&prgAzienda="+prgAzienda+"&prgRichiestaAZ="
