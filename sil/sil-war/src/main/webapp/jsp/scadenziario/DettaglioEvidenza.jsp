...
String prgTipoEvidenzaRic  = StringUtils.getAttributeStrNotNull(serviceRequest, "prgTipoEvidenzaRic");
String messaggioRic        = StringUtils.getAttributeStrNotNull(serviceRequest, "messaggioRic");
String tipoRicerca         = StringUtils.getAttributeStrNotNull(serviceRequest, "tipoRicerca");
String strCodiceFiscaleRic = StringUtils.getAttributeStrNotNull(serviceRequest, "strCodiceFiscaleRic");
String strCognomeRic       = StringUtils.getAttributeStrNotNull(serviceRequest, "strCognomeRic");
String strNomeRic          = StringUtils.getAttributeStrNotNull(serviceRequest, "strNomeRic");
...
<input type="hidden" name="prgTipoEvidenzaRic"  value="<%=prgTipoEvidenzaRic%>"/>
<input type="hidden" name="messaggioRic"        value="<%=messaggioRic%>"/>
<input type="hidden" name="tipoRicerca"         value="<%=tipoRicerca%>"/>
<input type="hidden" name="strCodiceFiscaleRic" value="<%=strCodiceFiscaleRic%>"/>
<input type="hidden" name="strCognomeRic"       value="<%=strCognomeRic%>"/>
<input type="hidden" name="strNomeRic"          value="<%=strNomeRic%>"/>
...
<%@ include file="_DettaglioEvidenza.inc" %>
