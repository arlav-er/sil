...
//Invio SMS
String flgInviatoSMS = row.containsAttribute("FLGINVIATOSMS")? row.getAttribute("FLGINVIATOSMS").toString():"";
String strCellSMSInvio = row.containsAttribute("STRCELLSMSINVIO")? row.getAttribute("STRCELLSMSINVIO").toString():"";
...
<p class="titolo">Dettaglio Contatto</p>
<p align="center">
...
<tr>
  ...
  <!--<af:textBox name="FLGINVIATOSMS"
			...
			<af:comboBox name="FLGINVIATOSMS" 
            size="1"
            title="Inviato"
            multiple="false" 
            disabled="true"
            ...
            focusOn="false"             
            selectedValue="<%=flgInviatoSMS%>" 
     		addBlank="true" 
     		blankValue="">
     		<OPTION value="" <%if (flgInviatoSMS.equals("")) out.print("SELECTED=\"true\"");%>></OPTION>     		
    		<OPTION value="S" <%if (flgInviatoSMS.equals("S")) out.print("SELECTED=\"true\"");%>>Sì</OPTION>
        	<OPTION value="N" <%if (flgInviatoSMS.equals("N")) out.print("SELECTED=\"true\"");%>>No</OPTION>
    		</af:comboBox>
  </td>
</tr>
