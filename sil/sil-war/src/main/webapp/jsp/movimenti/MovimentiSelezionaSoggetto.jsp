...
<%
   ...
   String titolo="";
   if (soggetto.equals("Lavoratori") || soggetto.equals("LavoratoriNew"))
   		titolo = "Lavoratori";
   else titolo = "Aziende";
   ...
   String codComRes = StringUtils.getAttributeStrNotNull(serviceRequest, "codComune");
...
<html>
  ...
  { 
	...
	<body class="gestione" onload="<%=(prosegui ? "prosegui();" : "")%>">
		<p class="titolo">Ricerca per <%=titolo%></p>
		<p align="center">
		<af:form name="Form1" method="POST" action="AdapterHTTP" onSubmit="checkCampiObbligatori()">
    <input type="hidden" name="PAGE" value="MovimentiListaSoggettoPage"/>
    ...
    <% if (soggetto.equals("Aziende") || soggetto.equals("Testate") ) {%>
   		...
   		<tr>
				...
				<td class="campo">
					...
					title="Comune"
					onKeyUp="PulisciRicerca(document.Form1.codComune, document.Form1.codComResHid, document.Form1.strComRes, document.Form1.strComResHid, null, null, 'codice');"
					type="text" name="codComune" value="<%=codComRes%>" size="4" maxlength="4"
					readonly="false"/>&nbsp; 
				<A
					HREF="javascript:btFindComuneCAP_onclick(document.Form1.codComune, document.Form1.strComRes, null, 'codice','');"><IMG
					...
					<af:textBox type="text"
								classNameBase="input"
								onKeyUp="PulisciRicerca(document.Form1.codComune, document.Form1.codComResHid, document.Form1.strComRes, document.Form1.strComResHid, null, null, 'descrizione');"
								name="strComRes" value="<%=strComRes%>" size="30" maxlength="50"
								readonly="false"/>
				<A
					HREF="javascript:btFindComuneCAP_onclick(document.Form1.codComune, document.Form1.strComRes, null, 'descrizione','');"><IMG
					name="image" border="0" src="../../img/binocolo.gif"
    ...
    <%} else if (soggetto.equals("Lavoratori") || soggetto.equals("LavoratoriNew")) {%>
            <tr>
