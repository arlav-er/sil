...
%><%
	...
	String filename = (responseBean != null && responseBean.getAttribute("M_EventiCondRicercaSaveCsv.fileExportEventiCsv") != null) ? 
			responseBean.getAttribute("M_EventiCondRicercaSaveCsv.fileExportEventiCsv").toString() : 
			"";
	String todayString = (new SimpleDateFormat("yyyyMMdd")).format(new Date());
	String outputFilename = "ListaEventiCondizionalita_" + todayString + ".csv";
