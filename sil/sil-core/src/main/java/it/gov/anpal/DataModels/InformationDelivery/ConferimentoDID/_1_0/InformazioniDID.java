...
public class InformazioniDID implements java.io.Serializable {
	...
	public InformazioniDID(it.gov.anpal.DataModels.InformationDelivery.ConferimentoDID._1_0.CodiceFiscale codiceFiscale,
	...
	static {
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://anpal.gov.it/DataModels/InformationDelivery/ConferimentoDID/1.0", "DataEvento"));
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://anpal.gov.it/DataModels/InformationDelivery/ConferimentoDID/1.0", "DataDID"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "dateTime"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://anpal.gov.it/DataModels/InformationDelivery/ConferimentoDID/1.0", "CodiceEntePromotore"));
