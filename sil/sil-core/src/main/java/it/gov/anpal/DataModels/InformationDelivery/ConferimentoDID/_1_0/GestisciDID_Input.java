...
public class GestisciDID_Input implements java.io.Serializable {
	...
	static {
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://anpal.gov.it/DataModels/InformationDelivery/ConferimentoDID/1.0", "InformazioniDID"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://anpal.gov.it/DataModels/InformationDelivery/ConferimentoDID/1.0", "InformazioniDID"));
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://anpal.gov.it/DataModels/InformationDelivery/ConferimentoDID/1.0", "GUIDOperatore"));
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://anpal.gov.it/DataModels/InformationDelivery/ConferimentoDID/1.0", "CodiceFiscaleOperatore"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setNillable(true);
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://anpal.gov.it/DataModels/InformationDelivery/ConferimentoDID/1.0", "Applicazione"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://anpal.gov.it/DataModels/InformationDelivery/ConferimentoDID/1.0", "Applicazione"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
