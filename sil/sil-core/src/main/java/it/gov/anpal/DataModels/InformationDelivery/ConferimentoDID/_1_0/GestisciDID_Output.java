...
public class GestisciDID_Output implements java.io.Serializable {
	...
	public GestisciDID_Output(it.gov.anpal.DataModels.InformationDelivery.ConferimentoDID._1_0.Profiling profiling,
	...
	static {
		...
		elemField.setXmlName(new javax.xml.namespace.QName(
				"http://anpal.gov.it/DataModels/InformationDelivery/ConferimentoDID/1.0", "Esito"));
