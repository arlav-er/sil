...
public class YG_Profiling_BindingQSServiceLocator extends org.apache.axis.client.Service
		implements it.gov.mlps.Services.InformationDelivery.YG_Profiling._1_0.YG_Profiling_BindingQSService {
	...
	private java.lang.String YG_Profiling_BindingQSPort_address = "http://localhost";
	...
	public it.gov.mlps.Services.InformationDelivery.YG_Profiling._1_0.YG_Profiling_PortType getYG_Profiling_BindingQSPort()
			throws javax.xml.rpc.ServiceException {
	...
	public it.gov.mlps.Services.InformationDelivery.YG_Profiling._1_0.YG_Profiling_PortType getYG_Profiling_BindingQSPort(
		...
		try {
			it.gov.mlps.Services.InformationDelivery.YG_Profiling._1_0.YG_Profiling_BindingStub _stub = new it.gov.mlps.Services.InformationDelivery.YG_Profiling._1_0.YG_Profiling_BindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (it.gov.mlps.Services.InformationDelivery.YG_Profiling._1_0.YG_Profiling_PortType.class
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName("http://mlps.gov.it/Services/InformationDelivery/YG_Profiling/1.0",
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName("http://mlps.gov.it/Services/InformationDelivery/YG_Profiling/1.0",
