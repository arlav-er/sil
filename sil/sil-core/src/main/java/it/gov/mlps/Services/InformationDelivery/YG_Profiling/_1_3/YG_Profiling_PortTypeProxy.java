...
public class YG_Profiling_PortTypeProxy
	...
	private it.gov.mlps.Services.InformationDelivery.YG_Profiling._1_3.YG_Profiling_PortType yG_Profiling_PortType = null;
	...
	private void _initYG_Profiling_PortTypeProxy() {
		try {
			yG_Profiling_PortType = (new it.gov.mlps.Services.InformationDelivery.YG_Profiling._1_3.YG_Profiling_BindingQSServiceLocator())
	...
	public it.gov.mlps.Services.InformationDelivery.YG_Profiling._1_3.YG_Profiling_PortType getYG_Profiling_PortType() {
		if (yG_Profiling_PortType == null)
			_initYG_Profiling_PortTypeProxy();
