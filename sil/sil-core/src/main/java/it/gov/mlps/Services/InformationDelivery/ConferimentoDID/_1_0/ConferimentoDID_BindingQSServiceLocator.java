...
public class ConferimentoDID_BindingQSServiceLocator extends org.apache.axis.client.Service
		implements it.gov.mlps.Services.InformationDelivery.ConferimentoDID._1_0.ConferimentoDID_BindingQSService {
	...
	public ConferimentoDID_BindingQSServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
			throws javax.xml.rpc.ServiceException {
		super(wsdlLoc, sName);
	}

	// Use to get a proxy class for ConferimentoDID_BindingQSPort
	private java.lang.String ConferimentoDID_BindingQSPort_address = "http://192.168.28.65:8088//mockConferimentoDID_Binding/gestisciDID";
	...
	public it.gov.mlps.Services.InformationDelivery.ConferimentoDID._1_0.ConferimentoDID_PortType getConferimentoDID_BindingQSPort()
			throws javax.xml.rpc.ServiceException {
	...
	public it.gov.mlps.Services.InformationDelivery.ConferimentoDID._1_0.ConferimentoDID_PortType getConferimentoDID_BindingQSPort(
		...
		try {
			it.gov.mlps.Services.InformationDelivery.ConferimentoDID._1_0.ConferimentoDID_BindingStub _stub = new it.gov.mlps.Services.InformationDelivery.ConferimentoDID._1_0.ConferimentoDID_BindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (it.gov.mlps.Services.InformationDelivery.ConferimentoDID._1_0.ConferimentoDID_PortType.class
					.isAssignableFrom(serviceEndpointInterface)) {
				it.gov.mlps.Services.InformationDelivery.ConferimentoDID._1_0.ConferimentoDID_BindingStub _stub = new it.gov.mlps.Services.InformationDelivery.ConferimentoDID._1_0.ConferimentoDID_BindingStub(
						new java.net.URL(ConferimentoDID_BindingQSPort_address), this);
				_stub.setPortName(getConferimentoDID_BindingQSPortWSDDServiceName());
				return _stub;
			}
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName("http://mlps.gov.it/Services/InformationDelivery/ConferimentoDID/1.0",
				"ConferimentoDID_BindingQSService");
	}
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(
					new javax.xml.namespace.QName("http://mlps.gov.it/Services/InformationDelivery/ConferimentoDID/1.0",
							"ConferimentoDID_BindingQSPort"));
		}
