...
public class YG_Profiling_BindingStub extends org.apache.axis.client.Stub
	...
	private static void _initOperationDesc1() {
		...
		param = new org.apache.axis.description.ParameterDesc(
				...
				new javax.xml.namespace.QName("http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0",
						"Insert_Input"),
				it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.Insert_Input.class, false, false);
		oper.addParameter(param);
		oper.setReturnType(new javax.xml.namespace.QName(
				"http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0", "YG_ProfilingCollection"));
		oper.setReturnClass(it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.YG_Profiling[].class);
		oper.setReturnQName(new javax.xml.namespace.QName(
				"http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0", "YG_ProfilingCollection"));
		param = oper.getReturnParamDesc();
		param.setItemQName(new javax.xml.namespace.QName(
				"http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0", "YG_Profiling"));
		...
		param = new org.apache.axis.description.ParameterDesc(
				...
				new javax.xml.namespace.QName("http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0",
						"Select_Input"),
				it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.Select_Input.class, false, false);
		oper.addParameter(param);
		oper.setReturnType(new javax.xml.namespace.QName(
				"http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0", "YG_ProfilingCollection"));
		oper.setReturnClass(it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.YG_Profiling[].class);
	...
	public YG_Profiling_BindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
		...
		qName = new javax.xml.namespace.QName("http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0",
				"CodiceFiscale");
		...
		qName = new javax.xml.namespace.QName("http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0",
				"esito");
		cachedSerQNames.add(qName);
		cls = it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.Esito.class;
		cachedSerClasses.add(cls);
		...
		qName = new javax.xml.namespace.QName("http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0",
				"Insert_Input");
		cachedSerQNames.add(qName);
		cls = it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.Insert_Input.class;
		cachedSerClasses.add(cls);
		...
		qName = new javax.xml.namespace.QName("http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0",
				"Select_Input");
		cachedSerQNames.add(qName);
		cls = it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.Select_Input.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		cachedDeserFactories.add(beandf);
		...
		qName = new javax.xml.namespace.QName("http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0",
				"sesso_out");
		cachedSerQNames.add(qName);
		cls = it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.Sesso_out.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(enumsf);
		cachedDeserFactories.add(enumdf);
		...
		qName = new javax.xml.namespace.QName("http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0",
				"YG_Profiling");
		cachedSerQNames.add(qName);
		cls = it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.YG_Profiling.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		cachedDeserFactories.add(beandf);
		...
		qName = new javax.xml.namespace.QName("http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0",
				"YG_Profiling");
		qName2 = new javax.xml.namespace.QName("http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0",
				"YG_Profiling");
	...
	public it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.YG_Profiling[] insert(
		...
		_call.setSOAPActionURI("http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0/insert");
		_call.setEncodingStyle(null);
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					return (it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.YG_Profiling[]) _resp;
				} catch (java.lang.Exception _exception) {
					return (it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.YG_Profiling[]) org.apache.axis.utils.JavaUtils
							.convert(_resp,
									it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.YG_Profiling[].class);
				}
			}
	...
	public it.gov.mlps.DataModels.InformationDelivery.YG_Profiling._1_0.YG_Profiling[] select(
		...
		_call.setUseSOAPAction(true);
		_call.setSOAPActionURI("http://mlps.gov.it/DataModels/InformationDelivery/YG_Profiling/1.0/select");
		_call.setEncodingStyle(null);
		_call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
		_call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
		_call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
