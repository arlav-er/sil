...
public class ServizicoapWSServiceLocator extends org.apache.axis.client.Service
		implements it.gov.lavoro.servizi.servizicoapSap.ServizicoapWSService {
	...
	public it.gov.lavoro.servizi.servizicoapSap.ServizicoapWS getservizicoapWS(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			it.gov.lavoro.servizi.servizicoapSap.ServizicoapWSSoapBindingStub _stub = new it.gov.lavoro.servizi.servizicoapSap.ServizicoapWSSoapBindingStub(
					portAddress, this);
