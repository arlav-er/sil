...
public class ServizicoapWSSoapBindingStub extends org.apache.axis.client.Stub
		implements it.gov.lavoro.servizi.servizicoap.ServizicoapWS {
	...
	private static void _initOperationDesc1() {
		...
		param = new org.apache.axis.description.ParameterDesc(
				...
				it.gov.lavoro.servizi.servizicoap.types.Risposta_invioSAP_TypeEsito.class, false, false);
		oper.addParameter(param);
		param = new org.apache.axis.description.ParameterDesc(
		...
		oper = new org.apache.axis.description.OperationDesc();
		oper.setName("richiestaCodSAPRegTitolare");
		param = new org.apache.axis.description.ParameterDesc(
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "CodiceFiscale"),
				org.apache.axis.description.ParameterDesc.IN,
				new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class,
		...
		oper.addParameter(param);
		param = new org.apache.axis.description.ParameterDesc(
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "CodiceRegione"),
				org.apache.axis.description.ParameterDesc.OUT,
				new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class,
				false, false);
		oper.addParameter(param);
		...
		param = new org.apache.axis.description.ParameterDesc(
				...
				it.gov.lavoro.servizi.servizicoap.types.Risposta_annullaSAP_TypeEsito.class, false, false);
		oper.addParameter(param);
		param = new org.apache.axis.description.ParameterDesc(
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "MessaggioErrore"),
				org.apache.axis.description.ParameterDesc.OUT,
		...
		param = new org.apache.axis.description.ParameterDesc(
				...
				it.gov.lavoro.servizi.servizicoap.types.Risposta_notificaSAP_TypeEsito.class, false, false);
		oper.addParameter(param);
		param = new org.apache.axis.description.ParameterDesc(
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "MessaggioErrore"),
				org.apache.axis.description.ParameterDesc.OUT,
		...
		oper = new org.apache.axis.description.OperationDesc();
		oper.setName("richiestaSAP_N00_A02");
		param = new org.apache.axis.description.ParameterDesc(
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "CodiceFiscale"),
				org.apache.axis.description.ParameterDesc.IN,
				new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class,
		...
		oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		oper.setReturnClass(java.lang.String.class);
		oper.setReturnQName(new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "DID"));
		oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
		oper.setUse(org.apache.axis.constants.Use.LITERAL);
		_operations[7] = oper;
	...
	public ServizicoapWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
		...
		cls = it.gov.lavoro.servizi.servizicoap.types.Risposta_annullaSAP_TypeEsito.class;
		...
		qName = new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types",
				">risposta_invioSAP_Type>Esito");
		cachedSerQNames.add(qName);
		cls = it.gov.lavoro.servizi.servizicoap.types.Risposta_invioSAP_TypeEsito.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(enumsf);
		cachedDeserFactories.add(enumdf);
		...
		qName = new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types",
				">risposta_notificaSAP_Type>Esito");
		cachedSerQNames.add(qName);
		cls = it.gov.lavoro.servizi.servizicoap.types.Risposta_notificaSAP_TypeEsito.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(enumsf);
		cachedDeserFactories.add(enumdf);
	...
	public void invioSAP(java.lang.String SAP,
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					esito.value = (it.gov.lavoro.servizi.servizicoap.types.Risposta_invioSAP_TypeEsito) _output.get(
							new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "Esito"));
				} catch (java.lang.Exception _exception) {
					esito.value = (it.gov.lavoro.servizi.servizicoap.types.Risposta_invioSAP_TypeEsito) org.apache.axis.utils.JavaUtils
							.convert(
									_output.get(new javax.xml.namespace.QName(
											"http://servizi.lavoro.gov.it/servizicoap/types", "Esito")),
									it.gov.lavoro.servizi.servizicoap.types.Risposta_invioSAP_TypeEsito.class);
				}
				try {
	...
	public void richiestaCodSAPRegTitolare(java.lang.String codiceFiscale, javax.xml.rpc.holders.StringHolder codiceSAP,
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					codiceRegione.value = (java.lang.String) _output.get(new javax.xml.namespace.QName(
							"http://servizi.lavoro.gov.it/servizicoap/types", "CodiceRegione"));
				} catch (java.lang.Exception _exception) {
					codiceRegione.value = (java.lang.String) org.apache.axis.utils.JavaUtils
							.convert(
									_output.get(new javax.xml.namespace.QName(
											"http://servizi.lavoro.gov.it/servizicoap/types", "CodiceRegione")),
									java.lang.String.class);
	...
	public void annullaSAP(java.lang.String codiceSAP,
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				_output = _call.getOutputParams();
				try {
					esito.value = (it.gov.lavoro.servizi.servizicoap.types.Risposta_annullaSAP_TypeEsito) _output.get(
							new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "Esito"));
				} catch (java.lang.Exception _exception) {
					esito.value = (it.gov.lavoro.servizi.servizicoap.types.Risposta_annullaSAP_TypeEsito) org.apache.axis.utils.JavaUtils
							.convert(
									_output.get(new javax.xml.namespace.QName(
											"http://servizi.lavoro.gov.it/servizicoap/types", "Esito")),
									it.gov.lavoro.servizi.servizicoap.types.Risposta_annullaSAP_TypeEsito.class);
				}
				try {
					messaggioErrore.value = (java.lang.String) _output.get(new javax.xml.namespace.QName(
							"http://servizi.lavoro.gov.it/servizicoap/types", "MessaggioErrore"));
	...
	public void notificaSAP(java.lang.String codiceSAP, java.lang.String motivoNotifica,
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				_output = _call.getOutputParams();
				try {
					esito.value = (it.gov.lavoro.servizi.servizicoap.types.Risposta_notificaSAP_TypeEsito) _output.get(
							new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "Esito"));
				} catch (java.lang.Exception _exception) {
					esito.value = (it.gov.lavoro.servizi.servizicoap.types.Risposta_notificaSAP_TypeEsito) org.apache.axis.utils.JavaUtils
							.convert(
									_output.get(new javax.xml.namespace.QName(
											"http://servizi.lavoro.gov.it/servizicoap/types", "Esito")),
									it.gov.lavoro.servizi.servizicoap.types.Risposta_notificaSAP_TypeEsito.class);
				}
				try {
					messaggioErrore.value = (java.lang.String) _output.get(new javax.xml.namespace.QName(
							"http://servizi.lavoro.gov.it/servizicoap/types", "MessaggioErrore"));
