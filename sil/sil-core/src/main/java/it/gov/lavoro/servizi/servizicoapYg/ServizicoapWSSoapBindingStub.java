...
public class ServizicoapWSSoapBindingStub extends org.apache.axis.client.Stub
		implements it.gov.lavoro.servizi.servizicoapYg.ServizicoapWS {
	...
	private static void _initOperationDesc1() {
		...
		param = new org.apache.axis.description.ParameterDesc(
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "UtenteYG"),
		...
		param = new org.apache.axis.description.ParameterDesc(
				...
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types",
						">risposta_invioUtenteYG_Type>Esito"),
				it.gov.lavoro.servizi.servizicoapYg.types.Risposta_invioUtenteYG_TypeEsito.class, false, false);
		oper.addParameter(param);
		param = new org.apache.axis.description.ParameterDesc(
		...
		param = new org.apache.axis.description.ParameterDesc(
				...
				it.gov.lavoro.servizi.servizicoapYg.types.Risposta_checkUtenteYG_TypeEsito.class, false, false);
		oper.addParameter(param);
		param = new org.apache.axis.description.ParameterDesc(
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "MessaggioErrore"),
				org.apache.axis.description.ParameterDesc.OUT,
	...
	public ServizicoapWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
		...
		cls = it.gov.lavoro.servizi.servizicoapYg.types.Risposta_checkUtenteYG_TypeEsito.class;
		...
		qName = new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types",
				">risposta_invioUtenteYG_Type>Esito");
		cachedSerQNames.add(qName);
		cls = it.gov.lavoro.servizi.servizicoapYg.types.Risposta_invioUtenteYG_TypeEsito.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(enumsf);
		cachedDeserFactories.add(enumdf);
	...
	public void invioUtenteYG(java.lang.String utenteYG,
		...
		_call.setOperationName(
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "invioUtenteYG"));

		String userSapKey = System.getProperty("BASIC_AUTH_YG_USERNAME");
		if (userSapKey != null && !("").equalsIgnoreCase(userSapKey)) {
			String pwdSapKey = System.getProperty("BASIC_AUTH_YG_PASSWORD");
		...
		try {
			java.lang.Object _resp = _call.invoke(new java.lang.Object[] { utenteYG });
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					esito.value = (it.gov.lavoro.servizi.servizicoapYg.types.Risposta_invioUtenteYG_TypeEsito) _output
							.get(new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types",
									"Esito"));
				} catch (java.lang.Exception _exception) {
					esito.value = (it.gov.lavoro.servizi.servizicoapYg.types.Risposta_invioUtenteYG_TypeEsito) org.apache.axis.utils.JavaUtils
							.convert(
									_output.get(new javax.xml.namespace.QName(
											"http://servizi.lavoro.gov.it/servizicoap/types", "Esito")),
									it.gov.lavoro.servizi.servizicoapYg.types.Risposta_invioUtenteYG_TypeEsito.class);
				}
				try {
	...
	public void checkUtenteYG(java.lang.String codiceFiscale,
		...
		_call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
		_call.setOperationName(
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "checkUtenteYG"));
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				_output = _call.getOutputParams();
				try {
					esito.value = (it.gov.lavoro.servizi.servizicoapYg.types.Risposta_checkUtenteYG_TypeEsito) _output
							.get(new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types",
									"Esito"));
				} catch (java.lang.Exception _exception) {
					esito.value = (it.gov.lavoro.servizi.servizicoapYg.types.Risposta_checkUtenteYG_TypeEsito) org.apache.axis.utils.JavaUtils
							.convert(
									_output.get(new javax.xml.namespace.QName(
											"http://servizi.lavoro.gov.it/servizicoap/types", "Esito")),
									it.gov.lavoro.servizi.servizicoapYg.types.Risposta_checkUtenteYG_TypeEsito.class);
				}
				try {
					messaggioErrore.value = (java.lang.String) _output.get(new javax.xml.namespace.QName(
							"http://servizi.lavoro.gov.it/servizicoap/types", "MessaggioErrore"));
