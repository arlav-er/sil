...
public class ServizicoapWSServiceLocator extends org.apache.axis.client.Service
		implements it.gov.lavoro.servizi.servizicoap.ServizicoapWSService {
	...
	private java.lang.String servizicoapWS_address = "http://192.168.28.157:80/mockservizicoapWSSoapBinding/richiestaSAP";
	...
	public it.gov.lavoro.servizi.servizicoap.ServizicoapWS getservizicoapWS(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			it.gov.lavoro.servizi.servizicoap.ServizicoapWSSoapBindingStub _stub = new it.gov.lavoro.servizi.servizicoap.ServizicoapWSSoapBindingStub(
					portAddress, this);
