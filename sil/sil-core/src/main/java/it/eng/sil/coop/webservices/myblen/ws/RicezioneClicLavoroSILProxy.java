...
public class RicezioneClicLavoroSILProxy
	...
	private it.eng.sil.coop.webservices.myblen.ws.RicezioneClicLavoroSIL_PortType ricezioneClicLavoroSIL_PortType = null;
	...
	private void _initRicezioneClicLavoroSILProxy() {
		try {
			ricezioneClicLavoroSIL_PortType = (new it.eng.sil.coop.webservices.myblen.ws.RicezioneClicLavoroSIL_ServiceLocator())
	...
	public it.eng.sil.coop.webservices.myblen.ws.RicezioneClicLavoroSIL_PortType getRicezioneClicLavoroSIL_PortType() {
		if (ricezioneClicLavoroSIL_PortType == null)
			_initRicezioneClicLavoroSILProxy();
