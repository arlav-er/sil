...
public class ASSetDefinitivaGraduatoria extends AbstractSimpleModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger
			.getLogger(ASSetDefinitivaGraduatoria.class.getName());
	...
	public void service(SourceBean request, SourceBean response) throws EMFInternalError {
		...
		try {
			...
			setGraduatoriaDefinitiva(request, response, numConfigValue);
	...
	public void setGraduatoriaDefinitiva(SourceBean request, SourceBean response, BigDecimal numConfigValue) {
		...
		try {
			...
			String statementUpdate = "AS_UPDATE_SET_DEFINITIVA_GRD";

			if (numConfigValue != null && numConfigValue.intValue() == 1) {
				statementUpdate = "AS_UPDATE_SET_DEFINITIVA_GRD_ONLINE";
			}
			statementSB = (SourceBean) getConfig().getAttribute(statementUpdate);
