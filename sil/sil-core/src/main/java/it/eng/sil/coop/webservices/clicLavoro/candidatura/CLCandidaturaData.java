...
public class CLCandidaturaData extends CLUtility {
	static Logger _logger = Logger.getLogger(CLCandidaturaData.class.getName());
	...
	final static String SCHEMA_XSD = "myportal" + File.separator + "clic_lavoro_candidatura_038.xsd";
	final static String SCHEMA_XSD_BLEN = "myportal" + File.separator + "clic_lavoro_candidatura_038_blen.xsd";

	Element candidaturaElement;

	public CLCandidaturaData() {

	}

	public CLCandidaturaData(String codiceFiscale, String codCPI, String dataInvio, List<String> codAmbDiff,
		...
		if (tipoComunicazione.equalsIgnoreCase(TIPOCOMUNICAZIONEBLEN)) {
			this.schemaXSD = SCHEMA_XSD_BLEN;
		}
	}
	...
	public CLCandidaturaData(String codCPI, String dataInvio, String tipoComunicazione) {
	...
	public void costruisci() throws MandatoryFieldException, FieldFormatException, EMFUserError {
		...
		if (tipoComunicazioneCL == null || tipoComunicazioneCL.equals("")
				|| tipoComunicazioneCL.equalsIgnoreCase(TIPOCOMUNICAZIONEBLEN)) {
			candidaturaElement.setAttribute("xsi:schemaLocation",
					"http://servizi.lavoro.gov.it/candidatura clic_lavoro_candidatura_038_blen.xsd");
		} else {
			candidaturaElement.setAttribute("xsi:schemaLocation",
					"http://servizi.lavoro.gov.it/candidatura clic_lavoro_candidatura_038.xsd");
		}
	...
	private void createElementDatiCurriculari(Element candidaturaElement, DataConnection dc)
		...
		datiCurriculariLavoratore.createElementProfessDesiderata(datiCurriculariElement, dc);
