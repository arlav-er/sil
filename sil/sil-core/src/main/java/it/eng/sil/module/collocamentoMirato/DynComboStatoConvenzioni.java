 ...
 *         Finestra&gt;Preferenze&gt;Java&gt;Generazione codice&gt;Codice e commenti
 */
public class DynComboStatoConvenzioni implements IDynamicStatementProvider2 {
	...
	private String SELECT_STATO_ATTO = " select sa.CODSTATOATTO as codice, "
			...
			+ "    and sat.CODLSTTAB = 'CM_CONV' ";

	public DynComboStatoConvenzioni() {
	}
	...
	public String getStatement(SourceBean req, SourceBean response) {
		...
		String codStato = StringUtils.getAttributeStrNotNull(req, "CODSTATOCONV");
