 ...
 * @author savino
 */
public class ModificaCodiceFiscaleIRMessage extends AbstractMessage implements IFaceMessage {

	private static final Logger log = Logger.getLogger(ModificaCodiceFiscaleIRMessage.class.getName());
	...
	public ModificaCodiceFiscaleIRMessage() {
	}
	...
	public void setObjectMessage(ObjectMessage msg) throws Exception {
		try {
			...
			testata.setServizio("ModificaCodiceFiscaleIR");
	...
	public void callWebservice() throws Exception {
		 ...
		 * 
		 * //EjbEndPointQ endPoint = new EjbEndPointQ("IdxRegServiziLavoratore"); EndPoint endPoint=new EndPoint();
		 * log.debug("EjbEndPointQ istanziato"); endPoint.init(dataSourceJndi, "IdxRegServiziLavoratore"); String
		 * address = endPoint.getUrl(); log.debug("Endpoint address: "+address);
		 ...
		 * 
		 * String retCode = service.modificaCodiceFiscaleIR( codiceFiscale, codiceFiscaleNuovo, cognome, nome,
		 * dataNascita, codComNascita, codProvinciaOp, codMonoTipoCpi, codCpi, dataInizio, testata.getCdnGruppo(),
