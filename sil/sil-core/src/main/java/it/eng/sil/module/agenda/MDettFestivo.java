...
public class MDettFestivo extends AbstractModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(MDettFestivo.class.getName());
	...
	public void service(SourceBean request, SourceBean response) {
		...
		try {
			if ((prgGiornoNl == null) || (prgGiornoNl.equals(""))) {
				prgGiornoNl = (String) getServiceResponse().getAttribute("MSALVAFESTIVO.prgGiornoNl");
