package it.eng.sil.action.report.curriculum;
...
public class CurriculumEuropeo extends AbstractSimpleReport {
		...
		if (apriFile != null && apriFile.equalsIgnoreCase("true")) {
			...
			try {
				...
				if (tipoFile != null)
					...
					setStrNomeDoc("CurriculumEuropeo.pdf");
				setStrDescrizione("Curriculum Europeo");
				setReportPath("Curriculum_Europeo/CV_EU_CC.rpt");
				...
				reportFailure(ue, "CurriculumEuropeo.service()", "");
			}
		} // else
	}
}// class CurriculumEuropeo
