...
public class SaveCarico extends AbstractSimpleModule {
	public void service(SourceBean request, SourceBean response) throws Exception {
		...
		try {
			...
			this.setSectionQueryUpdate("QUERY_UPDATE_CARICO");
			ret = doUpdate(request, response);

			if (!ret) {
				throw new Exception("impossibile aggiornare CM_LAV_CARICO in transazione");
			}
