...
public class AdapterWSServiceLocator extends org.apache.axis.client.Service
		implements it.eng.sil.coordinamento.wsClient.np.AdapterWSService {
	...
	private java.lang.String AdapterWS_address = "http://localhost:9080/AdapterWSWEB/services/AdapterWS";
	...
	public it.eng.sil.coordinamento.wsClient.np.AdapterWS_PortType getAdapterWS()
			throws javax.xml.rpc.ServiceException {
	...
	public it.eng.sil.coordinamento.wsClient.np.AdapterWS_PortType getAdapterWS(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			it.eng.sil.coordinamento.wsClient.np.AdapterWSSoapBindingStub _stub = new it.eng.sil.coordinamento.wsClient.np.AdapterWSSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (it.eng.sil.coordinamento.wsClient.np.AdapterWS_PortType.class
