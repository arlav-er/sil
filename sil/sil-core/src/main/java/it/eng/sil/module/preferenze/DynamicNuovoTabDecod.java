...
public class DynamicNuovoTabDecod implements IDynamicStatementProvider2 {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(DynamicNuovoTabDecod.class.getName());

	private String className = this.getClass().getName();

	public DynamicNuovoTabDecod() {
	}
	...
	public String getStatement(SourceBean request, SourceBean response) {
		...
		String query = new GenQuery(tab).generaInsert(request, response).toString();
