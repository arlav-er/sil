...
public class TrasmettiPattoServiceLocator extends org.apache.axis.client.Service
		implements it.eng.sil.coop.webservices.pattoonlinenew.TrasmettiPattoService {
	...
	private java.lang.String TrasmettiPatto_address = "http://localhost:28080/PattoOnline/services/TrasmettiPatto";
	...
	public it.eng.sil.coop.webservices.pattoonlinenew.TrasmettiPatto getTrasmettiPatto(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			it.eng.sil.coop.webservices.pattoonlinenew.TrasmettiPattoSoapBindingStub _stub = new it.eng.sil.coop.webservices.pattoonlinenew.TrasmettiPattoSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (it.eng.sil.coop.webservices.pattoonlinenew.TrasmettiPatto.class
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName("http://pattoonlinenew.webservices.coop.sil.eng.it",
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName("http://pattoonlinenew.webservices.coop.sil.eng.it",
					"TrasmettiPatto"));
		}
