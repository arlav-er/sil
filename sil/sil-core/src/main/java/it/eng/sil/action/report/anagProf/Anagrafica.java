...
public class Anagrafica extends AbstractSimpleReport {
	...
	public void service(SourceBean request, SourceBean response) {
		...
		if (apriFile != null && apriFile.equalsIgnoreCase("true")) {
			...
			try {
				setStrDescrizione("Anagrafica lavoratore");

				String tipoFile = (String) request.getAttribute("tipoFile");
				if (tipoFile != null)
					setStrNomeDoc("AnagraficaLavoratore." + tipoFile);
				else
					setStrNomeDoc("AnagraficaLavoratore.pdf");

				setReportPath("Anagrafica/Anagrafica_CC.rpt");
				...
				reportFailure(ue, "Anagrafica.service()", "");
			}
		} // else
	}
}