...
public class Export implements java.io.Serializable {
	...
	private java.lang.String intExportType;

	public Export() {
	}

	public Export(java.lang.String strLibraryName, java.lang.String lngDocID, java.lang.String strUserName,
			java.lang.String strDST, java.lang.String intExportType) {
		this.strLibraryName = strLibraryName;
		this.lngDocID = lngDocID;
		this.strUserName = strUserName;
		this.strDST = strDST;
		this.intExportType = intExportType;
	}

	/**
	 * Gets the strLibraryName value for this Export.
	 * 
	...
	/**
	 * Sets the strLibraryName value for this Export.
	 * 
	...
	/**
	 * Gets the lngDocID value for this Export.
	 * 
	 * @return lngDocID
	 */
	...
	/**
	 * Sets the lngDocID value for this Export.
	 * 
	 * @param lngDocID
	 */
	...
	/**
	 * Gets the strUserName value for this Export.
	 * 
	 * @return strUserName
	 */
	...
	/**
	 * Sets the strUserName value for this Export.
	 * 
	 * @param strUserName
	 */
	...
	/**
	 * Gets the strDST value for this Export.
	 * 
	 * @return strDST
	 */
	...
	/**
	 * Sets the strDST value for this Export.
	 * 
	 * @param strDST
	 */
	...
	/**
	 * Gets the intExportType value for this Export.
	 * 
	 * @return intExportType
	 */
	public java.lang.String getIntExportType() {
		return intExportType;
	}

	/**
	 * Sets the intExportType value for this Export.
	 * 
	 * @param intExportType
	 */
	public void setIntExportType(java.lang.String intExportType) {
		this.intExportType = intExportType;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& ((this.intExportType == null && other.getIntExportType() == null)
						|| (this.intExportType != null && this.intExportType.equals(other.getIntExportType())));
		__equalsCalc = null;
		return _equals;
	}
	...
	public synchronized int hashCode() {
		...
		if (getIntExportType() != null) {
			_hashCode += getIntExportType().hashCode();
		}
	...
	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", ">Export"));
		...
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();
		elemField.setFieldName("intExportType");
		elemField.setXmlName(new javax.xml.namespace.QName("http://tempuri.org/", "intExportType"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
