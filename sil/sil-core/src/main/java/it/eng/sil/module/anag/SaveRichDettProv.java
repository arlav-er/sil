...
public class SaveRichDettProv extends AbstractSimpleModule {
	public void service(SourceBean request, SourceBean response) throws Exception {
		...
		try {
			...
			this.setSectionQueryUpdate("QUERY_UPDATE_RICH_DETTPROV");
			ret = doUpdate(request, response);

			if (!ret) {
				throw new Exception("impossibile aggiornare CM_COMPTERR_DETTAGLIO in transazione");
			}
