...
public class MSaveCompetenzaRichiesta extends AbstractAlternativaSimpleModule {
	public void service(SourceBean request, SourceBean response) {
		...
		Collection elenco = AbstractSimpleModule.getArgumentValues(request, "CODCOMPETENZA");

		CollectionExecutor objExecutor = new CollectionExecutor(elenco, insertAction, "CODCOMPETENZA");
