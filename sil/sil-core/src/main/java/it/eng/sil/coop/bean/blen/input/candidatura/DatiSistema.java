...
@XmlType(name = "", propOrder = { "ambitodiffusione", "datainserimento", "datascadenza", "idintermediario",
		"codicefiscaleintermediario", "denominazioneintermediario", "indirizzo", "idcomune", "cap", "telefono", "fax",
		"email", "visibilita", "tipocandidatura", "motivochiusura", "codicecandidatura", "codicecandidaturaprecedente",
		"percettore" })
