 ...
 */
public class CMSalvaApprovaGrad extends AbstractSimpleModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(CMSalvaApprovaGrad.class.getName());
	...
	public void service(SourceBean request, SourceBean response) throws EMFInternalError {
		...
		try {
			...
			it.eng.sil.util.TraceWrapper.debug(_logger,
					"CMSalvaApprovaGrad::service(): Impossibile salvare approvazione graduatoria!", ex);
	...
	public void salvaApprovazione(SourceBean request, SourceBean response) {
		...
		try {
			...
			statementSB = (SourceBean) getConfig().getAttribute("CM_SALVA_APPROVAZ");
