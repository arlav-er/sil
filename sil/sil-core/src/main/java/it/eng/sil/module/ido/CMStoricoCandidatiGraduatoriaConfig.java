 ...
 */
public class CMStoricoCandidatiGraduatoriaConfig extends AbstractConfigProvider {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger
			.getLogger(CMStoricoCandidatiGraduatoriaConfig.class.getName());

	private String className = this.getClass().getName();

	public CMStoricoCandidatiGraduatoriaConfig() {
	}
	...
	public SourceBean getConfigSourceBean(SourceBean request, SourceBean response) {
		...
		String codmonotipogradcm = StringUtils.getAttributeStrNotNull(request, "codmonotipogradcm");
		...
		try {
			...
			if (!("12").equalsIgnoreCase(prgTipoIncrocio)) {
				...
				col_5.setAttribute("name", "dataIscrCM");
				col_5.setAttribute("label", "Data Iscr. CM");
				colonneSB.setAttribute(col_5);

				col_6.setAttribute("name", "reddito");
				col_6.setAttribute("label", "Reddito");
				colonneSB.setAttribute(col_6);

				col_7.setAttribute("name", "carico");
				col_7.setAttribute("label", "Carico");
				...
				col_15.setAttribute("name", "dataUltMov");
				col_15.setAttribute("label", "Data Ult. Mov.");
				colonneSB.setAttribute(col_15);

				col_16.setAttribute("name", "tipoUltMov");
				col_16.setAttribute("label", "Tipo Ult. Mov.");
			...
			oldPage.setAttribute("value", "CMStoricoDettGraduatoriaPage");
