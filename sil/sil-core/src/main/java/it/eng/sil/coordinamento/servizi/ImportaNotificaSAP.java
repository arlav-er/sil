...
public class ImportaNotificaSAP implements ServizioSoap {

	private static Logger logger = Logger.getLogger(ImportaNotificaSAP.class);

	public String elabora(Execute parametri) {
		String risultato = null;
		TransactionQueryExecutor tex = null;
		String serviceName = "RegistraNotificaSAP";
		String xmlNotificaSAP = parametri.getDati();
		Map param = new HashMap();

		param.put("servizio", "RegistraNotificaSAP");
		param.put("dati_xml", xmlNotificaSAP);
