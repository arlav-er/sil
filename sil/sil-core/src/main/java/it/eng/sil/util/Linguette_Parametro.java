...
public final class Linguette_Parametro {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(Linguette_Parametro.class.getName());
	 ...
	 */
	public Linguette_Parametro(int _codFunzione, String _page, BigDecimal _cdnLavoratore, String _parametro) {
		this(null, _codFunzione, _page, _cdnLavoratore, _parametro);
	}
	 ...
	 */
	public Linguette_Parametro(User user, int _codFunzione, String _page, BigDecimal _cdnLavoratore,
			String _parametro) {
	...
	public Linguette_Parametro(User user, int _codFunzione, String _page, String cdnLavoratoreEncrypt,
			String _parametro, boolean checkCrypt) {
