...
public class AssistErWSServiceLocator extends org.apache.axis.client.Service
		implements it.eng.sil.coop.webservices.asl.ServizioAslWSService {

	public AssistErWSServiceLocator() {
	}

	public AssistErWSServiceLocator(org.apache.axis.EngineConfiguration config) {
		super(config);
	}

	public AssistErWSServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName("http://assister.webservices.coop.sil.eng.it", "ServizioAslWSService");
	}
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName("http://assister.webservices.coop.sil.eng.it", "SpilAslWs"));
		}
