 ...
 *         Finestra&gt;Preferenze&gt;Java&gt;Generazione codice&gt;Codice e commenti
 */
public class DeleteAssunz extends AbstractSimpleModule {
	public void service(SourceBean request, SourceBean response) throws Exception {
		...
		try {
			...
			this.setSectionQueryDelete("QUERY_DELETE_ASS");
			ret = doDelete(request, response);

			if (!ret) {
				throw new Exception("impossibile cancellare in CM_CONV_DETTAGLIO in transazione");
			}
