...
public class ServizicoapWSServiceLocator extends org.apache.axis.client.Service
		implements it.eng.sil.coop.webservices.coapadesioneGet.ministero.ServizicoapWSService {
	...
	public it.eng.sil.coop.webservices.coapadesioneGet.ministero.ServizicoapWS getservizicoapWS(
		...
		try {
			it.eng.sil.coop.webservices.coapadesioneGet.ministero.ServizicoapWSSoapBindingStub _stub = new it.eng.sil.coop.webservices.coapadesioneGet.ministero.ServizicoapWSSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (it.eng.sil.coop.webservices.coapadesioneGet.ministero.ServizicoapWS.class
