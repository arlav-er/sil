...
public class StoricizzaRichieste extends AbstractModule {
	private String className = this.getClass().getName();

	public StoricizzaRichieste() {
	}
	...
	public void service(SourceBean request, SourceBean response) {
		...
		try {
			...
			// String b = Integer.toString(user.getCodut());
			...
			response.setAttribute("PRGRICHIESTAAZ", codiceRit);
