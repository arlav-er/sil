...
public class GetProssimoDispo extends AbstractModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(GetProssimoDispo.class.getName());
