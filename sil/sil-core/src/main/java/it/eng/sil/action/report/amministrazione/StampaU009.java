...
public class StampaU009 extends AbstractSimpleReport {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(StampaU009.class.getName());

	private static final long serialVersionUID = 9015433517028506547L;

	private static String reportDescription = "U009";
	private static String reportRelativePath = "Amministrazione/StampaU009_UMB_CC.rpt";
	private static String reportOutputFileName = "U009";
