...
public class ApiStampaTDA {
	...
	public void setElencoVouchers(Vector elencoVouchers) {
		this.elencoVouchers = elencoVouchers;
	}
	...
	public ApiStampaTDA(SourceBean conf) {
		this.config = conf;
	}
	...
	public void start() throws Exception {
		try {
			...
			eng.setReportTitle("Lista Titoli di Acquisto");
			...
			stampaIntestazione(ph, elencoVouchers);
			stampaElencoVouchers(details, elencoVouchers);
		} catch (Exception e) {
			throw e;
		}
	}
	...
	private void testata(Area area) throws Exception {
		...
		tp = p.addTextPart("Lista Titoli di Acquisto");
	...
	private void stampaIntestazione(Area ph, Vector rows) throws Exception {
		...
		t = ReportUtils.addText(section, "Nome", s, 340);
		t.setHeight(600);

		t = addText(section, "Codice Fiscale", s, 630);
		t.setHeight(600);

		t = addText(section, "Azione", s, 930);
		t.setHeight(600);

		t = addText(section, "Data concl.", s, 1160);
		t.setHeight(600);

		t = addText(section, "Data attiv.", s, 1450);
		t.setHeight(600);

		t = addText(section, "Ente Attivato", s, 1810);
		t.setHeight(600);

		t = addText(section, "Stato Titolo", s, 2070);
		t.setHeight(600);

		t = addText(section, "Codice attiv.", s, 2360);
		t.setHeight(600);

		t = addText(section, "CPI", s, 2650);
		t.setHeight(600);

		addBR(ph, 10);
	}

	private void stampaElencoVouchers(Area details, Vector rows) throws Exception {
	...
	private void azione(Area details, SourceBean infoAzione) throws Exception {
		...
		String nome = StringUtils.getAttributeStrNotNull(infoAzione, "STRNOME");
		String cognome = StringUtils.getAttributeStrNotNull(infoAzione, "STRCOGNOME");
		String codiceFiscale = StringUtils.getAttributeStrNotNull(infoAzione, "STRCODICEFISCALE");
		String azione = StringUtils.getAttributeStrNotNull(infoAzione, "DESCAZIONE");
		String concludereEntroIl = StringUtils.getAttributeStrNotNull(infoAzione, "DATMAXEROGAZIONE");
		String dataAttivazione = StringUtils.getAttributeStrNotNull(infoAzione, "DATATTIVAZIONE");
		String enteAttivato = StringUtils.getAttributeStrNotNull(infoAzione, "ENTEATTIVATO");
		String statoTitolo = StringUtils.getAttributeStrNotNull(infoAzione, "STATOVOUCHER");
		String codiceAttivazione = StringUtils.getAttributeStrNotNull(infoAzione, "CODATTIVAZIONE");
		String cpi = StringUtils.getAttributeStrNotNull(infoAzione, "CPICOMPTIT");

		t = addText(section, nome, 8, 50, 290);
		t.setCanGrow(true);

		t = addText(section, cognome, 8, 340, 290);
		t.setCanGrow(true);

		t = addText(section, codiceFiscale, 8, 630, 290);
		t.setCanGrow(true);

		t = addText(section, azione, 8, 930, 290);
		t.setCanGrow(true);

		t = addText(section, concludereEntroIl, 8, 1160, 330);
		t.setCanGrow(true);

		t = addText(section, dataAttivazione, 8, 1450, 290);
		t.setCanGrow(true);

		t = addText(section, enteAttivato, 8, 1810, 330);
		t.setCanGrow(true);

		t = addText(section, statoTitolo, 8, 2070, 290);
		t.setCanGrow(true);

		t = addText(section, codiceAttivazione, 8, 2360, 290);
		t.setCanGrow(true);

		t = addText(section, cpi, 8, 2650, 290);
		t.setCanGrow(true);
	}
