...
public class SalvaRichComTerDocumento extends AbstractSimpleModule {
	private final String className = StringUtils.getClassName(this);
	private final String updCompTerr = "Aggiornamento Richiesta Comp. Territoriali effettuata con successo";
