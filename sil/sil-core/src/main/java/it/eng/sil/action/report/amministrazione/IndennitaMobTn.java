...
public class IndennitaMobTn extends AbstractSimpleReport {
	...
	public void service(SourceBean request, SourceBean response) {
		...
		if (apriFile != null && apriFile.equalsIgnoreCase("true")) {
			...
			try {
				setStrDescrizione("Domanda di indennità regionale di mobilità");

				String tipoFile = (String) request.getAttribute("tipoFile");
				if (tipoFile != null)
					setStrNomeDoc("IndennitaMob." + tipoFile);
				else
					setStrNomeDoc("IndennitaMob.pdf");

				setReportPath("Amministrazione/IndennitaMob_CC.rpt");
