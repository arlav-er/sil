...
public class ApiStampaProspetti_Central_Masso {
	...
	//
	private String scopertura_nved_masso = null;
	private String numscoperturanved = null;
	private String numscoperturamassofisio = null;
	...
	public ApiStampaProspetti_Central_Masso(SourceBean conf) {
		this.config = conf;
	}
	...
	private void stampaIntestazioneAziProspetto(Area ph, Vector rows, boolean flgMatchingPesato) throws Exception {
		...
		t = addText(section, "Num\nArt18", s, LEFT + 2160);
		t.setHeight(500);
		t = addText(section, "Stato", s, LEFT + 2300);
		t.setHeight(500);
		t = addText(section, "Note", s, LEFT + 2450);
		t.setHeight(500);

		/*
		 * t = addText(section, "Nom.\nDis", s, LEFT +1700); t.setHeight(500); t = addText(section, "Num\nDis", s, LEFT
		 * +1845); t.setHeight(500); t = addText(section, "Nom\nArt18", s, LEFT +1990); t.setHeight(500); t =
		 * addText(section, "Num\nArt18", s, LEFT +2135); t.setHeight(500); t = addText(section, "Stato", s, LEFT
		 * +2250); t.setHeight(500); t = addText(section, "Note", s, LEFT +2430); t.setHeight(500); //Masso e
		 * Centralinista t = addText(section, "Masso/\nCentral", s, LEFT +2530); t.setHeight(500);
		 */
	...
	private void aziende(Area details, SourceBean getProspetti) throws Exception {
		...
		// Masso e Centralinista
		String numscoperturanved = it.eng.afExt.utils.StringUtils.getAttributeStrNotNull(getProspetti,
				"numscoperturanved");
		String numscoperturamassofisio = it.eng.afExt.utils.StringUtils.getAttributeStrNotNull(getProspetti,
				"numscoperturamassofisio");
		String scopertura_nved_masso = numscoperturanved + "/" + numscoperturamassofisio;
		...
		// Ale
		t = addText(section, scopertura_nved_masso, 8, LEFT + 1740, 200);
		t.setCanGrow(true);

		t = addText(section, disScopNom, 8, LEFT + 1885, 220);
		t.setCanGrow(true);

		t = addText(section, disScopNum, 8, LEFT + 1980, 220);
		t.setCanGrow(true);

		t = addText(section, art18ScopNom, 8, LEFT + 2085, 220);
		t.setCanGrow(true);

		t = addText(section, art18ScopNum, 8, LEFT + 2180, 220);
		t.setCanGrow(true);

		t = addText(section, stato, 8, LEFT + 2300, 200);
		t.setCanGrow(true);

		t = addText(section, note, 8, LEFT + 2450, 200);
		t.setCanGrow(true);

		/*
		 * t = addText(section, disScopNom, 8,LEFT +1720,220); t.setCanGrow(true);
		 * 
		 * t = addText(section, disScopNum, 8,LEFT +1865,220); t.setCanGrow(true);
		 * 
		 * t = addText(section, art18ScopNom, 8,LEFT +2010,220); t.setCanGrow(true);
		 * 
		 * t = addText(section, art18ScopNum, 8,LEFT +2155,220); t.setCanGrow(true);
		 * 
		 * t = addText(section, stato, 8,LEFT +2250,200); t.setCanGrow(true);
		 * 
		 * t = addText(section, note, 8,LEFT +2430,200); t.setCanGrow(true);
		 * 
		 * t = addText(section, scopertura_nved_masso, 8,LEFT +2530,200); t.setCanGrow(true);
		 */
	}
