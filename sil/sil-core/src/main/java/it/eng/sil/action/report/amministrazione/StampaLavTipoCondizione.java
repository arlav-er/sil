...
public class StampaLavTipoCondizione extends AbstractSimpleReport {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(StampaLavTipoCondizione.class.getName());
	...
	public void service(SourceBean request, SourceBean response) {
		...
		if (apriFile != null && apriFile.equalsIgnoreCase("true")) {
			...
			if (tipoFile != null)
				setStrNomeDoc("LavTipoCondizione." + tipoFile);
			else
				setStrNomeDoc("LavTipoCondizione.pdf");
			setStrDescrizione("Lavoratori tipo condizione");
	...
	com.inet.report.Engine executeQueriesLavTipoCond(SourceBean request, SourceBean response) throws Exception {
		...
		ApiStampaLavTipoCondizione report = new ApiStampaLavTipoCondizione((SourceBean) getConfig());
