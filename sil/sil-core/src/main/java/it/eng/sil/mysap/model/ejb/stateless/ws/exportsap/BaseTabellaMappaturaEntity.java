/**
 * BaseTabellaMappaturaEntity.java
 *
...
public abstract class BaseTabellaMappaturaEntity extends it.eng.sil.mysap.model.ejb.stateless.ws.exportsap.BaseEntity
		implements java.io.Serializable {
	private java.util.Calendar dtFineVal;

	private java.util.Calendar dtInizioVal;

	public BaseTabellaMappaturaEntity() {
	}

	public BaseTabellaMappaturaEntity(java.util.Calendar dtFineVal, java.util.Calendar dtInizioVal) {
		this.dtFineVal = dtFineVal;
		this.dtInizioVal = dtInizioVal;
	}

	/**
	 * Gets the dtFineVal value for this BaseTabellaMappaturaEntity.
	 * 
	 * @return dtFineVal
	 */
	...
	/**
	 * Sets the dtFineVal value for this BaseTabellaMappaturaEntity.
	 * 
	 * @param dtFineVal
	 */
	...
	/**
	 * Gets the dtInizioVal value for this BaseTabellaMappaturaEntity.
	 * 
	 * @return dtInizioVal
	 */
	...
	/**
	 * Sets the dtInizioVal value for this BaseTabellaMappaturaEntity.
	 * 
	 * @param dtInizioVal
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof BaseTabellaMappaturaEntity))
			return false;
		BaseTabellaMappaturaEntity other = (BaseTabellaMappaturaEntity) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
