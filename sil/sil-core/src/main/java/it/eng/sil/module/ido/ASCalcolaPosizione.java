 ...
 */
public class ASCalcolaPosizione extends AbstractSimpleModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(ASCalcolaPosizione.class.getName());
	...
	public void service(SourceBean request, SourceBean response) throws EMFInternalError {
		...
		try {
			...
			it.eng.sil.util.TraceWrapper.debug(_logger,
					"ASCalcolaPosizione::service(): Impossibile calcolare la posizione!", ex);
	...
	public void calcolaPosizione(SourceBean request, SourceBean response) {
		...
		try {
			...
			statementSB = (SourceBean) getConfig().getAttribute("AS_CALCOLO_POSIZIONE_CANDIDATO");
