...
/*
 * Restituisce una lista paginata delle settimane tipo relative ad un CPI
 * 
...
/**
 * GG 28/9/2004 - MA QUESTO MODULO VIENE USATO DA QUALCUNO??
 */
public class ListSettTipoModule extends AbstractBasicListModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(ListSettTipoModule.class.getName());

	public ListSettTipoModule() {
	}
