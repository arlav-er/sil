...
public class RicercaUnitaAzienda implements IDynamicStatementProvider {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(RicercaUnitaAzienda.class.getName());

	public RicercaUnitaAzienda() {
	}
	...
	private static final String SELECT_SQL_BASE = "select " + "UAZ.PRGAZIENDA PRGAZIENDA, " + "UAZ.PRGUNITA PRGUNITA, "
			...
			+ "COM.STRCAP STRCAP, "
			+ "DECCNL.STRDESCRIZIONE || DECODE ( SYSDATE, GREATEST(SYSDATE, DECCNL.DATINIZIOVAL, DECCNL.DATFINEVAL), ' (scaduto)', LEAST(SYSDATE, DECCNL.DATINIZIOVAL, DECCNL.DATFINEVAL), ' (scaduto)', '' ) STRDESCRIZIONECCNL"
			+ ", " + "UAZ.CODCCNL CCNLAZ, "
	...
	public String getStatement(RequestContainer requestContainer, SourceBean config) {
		...
		String prgUnita = (String) req.getAttribute("PRGUAZ");
