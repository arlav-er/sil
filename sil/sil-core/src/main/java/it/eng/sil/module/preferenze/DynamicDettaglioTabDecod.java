...
public class DynamicDettaglioTabDecod implements IDynamicStatementProvider2 {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger
			.getLogger(DynamicDettaglioTabDecod.class.getName());

	private String className = this.getClass().getName();

	public DynamicDettaglioTabDecod() {
	}
	...
	public String getStatement(SourceBean request, SourceBean response) {
		...
		String query = new GenQuery(tab).generaSelectDettaglio(request, response).toString();
