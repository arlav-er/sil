...
public class ApiStampaLavTipoCondizione {
	...
	public ApiStampaLavTipoCondizione(SourceBean conf) {
		this.config = conf;
	}
	...
	private void stampaIntestazione(Area ph, Vector rows, boolean flgMatchingPesato) throws Exception {
		...
		t.setHeight(600);
		t = ReportUtils.addText(section, "Nome", s, LEFT + 270);
		t.setHeight(600);
		t = ReportUtils.addText(section, "Codice Fiscale", s, LEFT + 550);
		t.setHeight(600);
		...
		t = addText(section, "Indirizzo\n Domicilio", s, LEFT + 1440);
		t.setHeight(600);

		t = addText(section, "Comune\n Domicilio", s, LEFT + 1710);
		t.setHeight(600);

		t = addText(section, "Tipo\n Condizione", s, LEFT + 2010);
		t.setHeight(600);
		t = addText(section, "CPI Titolare", s, LEFT + 2270);
		t.setHeight(600);
		addBR(ph, 10);
	}
	...
	private void azione(Area details, SourceBean infoAzione) throws Exception {
		...
		String cognome = it.eng.afExt.utils.StringUtils.getAttributeStrNotNull(infoAzione, "STRCOGNOME");
		String nome = it.eng.afExt.utils.StringUtils.getAttributeStrNotNull(infoAzione, "STRNOME");
		String codFiscale = it.eng.afExt.utils.StringUtils.getAttributeStrNotNull(infoAzione, "STRCODICEFISCALE");
		...
		String indDom = it.eng.afExt.utils.StringUtils.getAttributeStrNotNull(infoAzione, "strindirizzodom");
		String comDom = it.eng.afExt.utils.StringUtils.getAttributeStrNotNull(infoAzione, "comDom");
		...
		t = addText(section, datNasc, 8, LEFT + 930, 220);
		t.setCanGrow(true);

		t = addText(section, comNasc, 8, LEFT + 1150, 260);
		t.setCanGrow(true);

		t = addText(section, indDom, 8, LEFT + 1440, 260);
		t.setCanGrow(true);

		t = addText(section, comDom, 8, LEFT + 1710, 260);
		t.setCanGrow(true);

		t = addText(section, tipoCond, 8, LEFT + 2010, 260);
		t.setCanGrow(true);

		t = addText(section, cpi, 8, LEFT + 2270, 220);
		t.setCanGrow(true);
	}
