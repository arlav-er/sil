...
public class InvioVacancyMyBlenMessage extends AbstractMessage implements IFaceMessage {
	...
	public InvioVacancyMyBlenMessage() {
	}

	public InvioVacancyMyBlenMessage(String usernameWs, String passwordWs, String statoVacancy, String prgRichiestaAz) {
	...
	public void setObjectMessage(ObjectMessage msg) throws Exception {
		...
		try {
			...
			testata.setServizio("InvioVacancyMyBlen");
	...
	public void callWebservice() throws Exception {
		...
		param.setServizio("InvioVacancyMyBlen");
