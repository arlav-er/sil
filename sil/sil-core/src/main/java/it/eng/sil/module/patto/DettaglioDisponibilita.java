...
/*
 * Questa classe restituisce il dettaglio di una disponibilità .
 * 
...
public class DettaglioDisponibilita extends AbstractModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(DettaglioDisponibilita.class.getName());
