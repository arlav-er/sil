...
public class StampaAllegatoU3 extends AbstractSimpleReport {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(StampaAllegatoU3.class.getName());

	private static final long serialVersionUID = 9015433517028506547L;

	private static String reportDescription = "Allegato U3";
	private static String reportRelativePath = "Amministrazione/StampaAllegatoU3_UMB_CC.rpt";
	private static String reportOutputFileName = "AllegatoU3";
