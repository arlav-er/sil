...
public class BLOB implements java.io.Serializable {
	...
	private it.eng.sil.coop.webservices.firmagrafometrica.MyMapOf_xsd_string_To_xsd_anyType_Item[] attributes;

	public BLOB() {
	}

	public BLOB(java.lang.String contentType, byte[] binaryData, java.lang.String attachmentID,
			java.lang.String remoteURL, byte[] MTOM, org.apache.axis.types.URI swaRef,
			it.eng.sil.coop.webservices.firmagrafometrica.MyMapOf_xsd_string_To_xsd_anyType_Item[] attributes) {
	 ...
	 * @return attributes
	 */
	public it.eng.sil.coop.webservices.firmagrafometrica.MyMapOf_xsd_string_To_xsd_anyType_Item[] getAttributes() {
		return attributes;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& ((this.MTOM == null && other.getMTOM() == null)
						|| (this.MTOM != null && java.util.Arrays.equals(this.MTOM, other.getMTOM())))
				&& ((this.swaRef == null && other.getSwaRef() == null)
						|| (this.swaRef != null && this.swaRef.equals(other.getSwaRef())))
				&& ((this.attributes == null && other.getAttributes() == null) || (this.attributes != null
	...
	public synchronized int hashCode() {
		...
		if (getMTOM() != null) {
			for (int i = 0; i < java.lang.reflect.Array.getLength(getMTOM()); i++) {
	...
	static {
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://firmagrafometrica.webservices.coop.sil.eng.it", "contentType"));
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://firmagrafometrica.webservices.coop.sil.eng.it", "binaryData"));
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://firmagrafometrica.webservices.coop.sil.eng.it", "attachmentID"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://firmagrafometrica.webservices.coop.sil.eng.it", "remoteURL"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://firmagrafometrica.webservices.coop.sil.eng.it", "MTOM"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "base64Binary"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://firmagrafometrica.webservices.coop.sil.eng.it", "swaRef"));
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://firmagrafometrica.webservices.coop.sil.eng.it", "attributes"));
		elemField.setXmlType(new javax.xml.namespace.QName("http://firmagrafometrica.webservices.coop.sil.eng.it",
				"MyMapOf_xsd_string_To_xsd_anyType_Item"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		elemField.setItemQName(
				new javax.xml.namespace.QName("http://firmagrafometrica.webservices.coop.sil.eng.it", "item"));
		typeDesc.addFieldDesc(elemField);
	}
