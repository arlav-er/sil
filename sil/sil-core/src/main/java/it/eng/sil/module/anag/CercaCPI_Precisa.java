...
public class CercaCPI_Precisa extends AbstractModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(CercaCPI_Precisa.class.getName());
