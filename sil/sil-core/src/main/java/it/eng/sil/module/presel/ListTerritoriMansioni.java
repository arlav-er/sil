...
public class ListTerritoriMansioni extends AbstractSimpleModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(ListTerritoriMansioni.class.getName());
	...
	public void service(SourceBean request, SourceBean response) {
		...
		if (Sottosistema.CM.isOff()) {
			...
			// END-PARTE-TEMP
			setSectionQuerySelect("QUERY_GET_MANSIONI_LAV_CM");
			// INIT-PARTE-TEMP
		}
		// END-PARTE-TEMP
		...
		try {
			...
			_logger.debug("sil.module.presel.ListTerritoriMansioni" + "::Errore in setAttribute" + ex.getMessage());
