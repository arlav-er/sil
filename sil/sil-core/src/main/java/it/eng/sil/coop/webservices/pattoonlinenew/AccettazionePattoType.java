...
public class AccettazionePattoType implements java.io.Serializable {
	...
	static {
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://pattoonlinenew.webservices.coop.sil.eng.it", "dtmAccettazione"));
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://pattoonlinenew.webservices.coop.sil.eng.it", "tipoAccettazione"));
