 ...
 * commenti
 */
public class DynRicercaAgendaLavoratoriSMSMassivo implements IDynamicStatementProvider {
	public DynRicercaAgendaLavoratoriSMSMassivo() {
	}
	...
	private static final String SELECT_SQL_BASE = " SELECT "
		...
		//	+ " DE_SERVIZIO.CODSERVIZIO , "
			...
			// DA ELIMINARE SOLO PER FARE TEST !!!
			+ " AND AN_LAVORATORE.FLGINVIOSMS= 'S'"
