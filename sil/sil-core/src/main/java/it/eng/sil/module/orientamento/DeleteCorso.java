...
public class DeleteCorso extends AbstractSimpleModule {
	public void service(SourceBean request, SourceBean response) throws Exception {
		...
		try {
			...
			if (!ret) {
				throw new Exception("Impossibile Eliminare il corso. Esiste un percorso associato.");
			}
			...
			reportOperation.reportFailure(MessageCodes.Corso.ESISTEPERCORSO, e, "services()", "delete in transazione");
		} finally {
		}
	}
}
