...
public class SalvaRichEsonDocumento extends AbstractSimpleModule {
	private final String className = StringUtils.getClassName(this);
	private final String updRichGrad = "Aggiornamento Richiesta Esonero effettuata con successo";
