 ...
 * codateco dell'unità azienda esiste in notazione puntata
 * profilo richiesto, mansione esiste in modalità puntata
 * il codice mansione dell'azienda è presente e corretto 
*/
public class RicercaDiPersonaleTestSuiteCostruzione {

	private static final int minPrgRichiestaAz = 0;
	private static final int maxPrgRichiestaAz = 80000;
	...
	public static Test suite() {
		...
		for (int i = 0; i < test_cases.size(); i++) {
			...
			RicercaDiPersonaleTestCostruzione caso = new RicercaDiPersonaleTestCostruzione(bdRichiesta, bdAlternativa,
					codCPI);
