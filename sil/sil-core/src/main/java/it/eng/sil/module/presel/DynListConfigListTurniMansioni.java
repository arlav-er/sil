 ...
 * @author Rolfini
 */
public class DynListConfigListTurniMansioni extends AbstractConfigProvider {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger
			.getLogger(DynListConfigListTurniMansioni.class.getName());
	...
	public SourceBean getConfigSourceBean(SourceBean request, SourceBean response) {
		...
		PageAttribs attributi = new PageAttribs(user, "TurniMansioniPage");

		boolean canDelete = attributi.containsButton("rimuovi");

		String configXmlStr = "<CONFIG pool=\"SIL_DATI\" title=\"\">" + "<QUERY statement=\"LOAD_TURNI_MANSIONI\">"
				+ "<PARAMETER scope=\"SERVICE_REQUEST\" type=\"RELATIVE\" value=\"CDNLAVORATORE\"/>" + "</QUERY>";

		String checkBoxXmlStr = "<CHECKBOXES>"
				+ "<CHECKBOX name=\"CK_CANCTURNO\" label=\"\" refColumn=\"\" jsCheckBoxClick=\"\">"
				+ "<CHECKBOXVALUE name=\"PRGDISTURNO\" scope=\"LOCAL\" type=\"RELATIVE\" value=\"PRGDISTURNO\"/>"
				+ "</CHECKBOX>" + "</CHECKBOXES>";

		String columnCaptionXmlStr = "<COLUMNS>" + "<COLUMN name=\"DESC_MANSIONE\" label=\"Mansione\" />"
				+ "<COLUMN name=\"DESC_TURNO\" label=\"Turno\"/>"
				+ "<COLUMN name=\"STRINSERIMENTO\" label=\"Inserimento\"/>" + "</COLUMNS>" + "<CAPTIONS>"
				+ "<DELETE_CAPTION image=\"../../img/del.gif\" label=\"\" confirm=\"false\">"
				+ "<PARAMETER name=\"PRGDISTURNO\" type=\"RELATIVE\" value=\"PRGDISTURNO\" scope=\"LOCAL\"/>"
				+ "<PARAMETER name=\"DESC_TURNO\" type=\"RELATIVE\" value=\"DESC_TURNO\" scope=\"LOCAL\"/>"
