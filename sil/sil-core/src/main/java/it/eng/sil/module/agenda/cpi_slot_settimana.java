...
/*
 * Questa classe restituisce il sommario settimanale degli slot 
 * 
 * @author: Stefania Orioli
 * 
 */

public class cpi_slot_settimana implements IDynamicStatementProvider {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(cpi_slot_settimana.class.getName());

	public cpi_slot_settimana() {
	}
	...
	private static final String SELECT_SQL_BASE = "select to_char(data, 'dd/mm/yyyy') as data, "
			...
			+ "STRDESCFASCIA, data AS DATDATA, numero AS NUMNUMERO " + "from vw_report_settima_slot " + "where "
			+ "data between ";
	...
	public String getStatement(RequestContainer requestContainer, SourceBean config) {
		...
		if (cdnTipoGruppo == 1) {
			...
			codCpi = req.getAttribute("slot_codCpi").toString();
		}
		...
		// Debug
		_logger.debug("sil.module.agenda.cpi_slot_settimana" + "::Stringa di ricerca:" + query_totale.toString());
