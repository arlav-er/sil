...
public class UpdateConv extends AbstractSimpleModule {
	public void service(SourceBean request, SourceBean response) throws Exception {
		...
		try {
			...
			this.setSectionQueryUpdate("QUERY_UPDATE_CONV");
			ret = doUpdate(request, response);

			if (!ret) {
				throw new Exception("impossibile aggiornare CM_CONVENZIONE in transazione");
			}
