...
public class ServizicoapWSSoapBindingStub extends org.apache.axis.client.Stub
		implements it.eng.sil.coop.webservices.coapadesioneGet.ministero.ServizicoapWS {
	...
	private static void _initOperationDesc1() {
		...
		param = new org.apache.axis.description.ParameterDesc(
				...
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types",
						">risposta_getStatoAdesioneYG_Type>Esito"),
				it.eng.sil.coop.webservices.coapadesioneGet.ministero.types.Risposta_getStatoAdesioneYG_TypeEsito.class,
				false, false);
		oper.addParameter(param);
		param = new org.apache.axis.description.ParameterDesc(
		...
		oper.addParameter(param);
		param = new org.apache.axis.description.ParameterDesc(
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "DataAdesione"),
				org.apache.axis.description.ParameterDesc.OUT,
				new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "date"), java.util.Date.class, false,
				false);
		oper.addParameter(param);
		param = new org.apache.axis.description.ParameterDesc(
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "StatoAdesione"),
				org.apache.axis.description.ParameterDesc.OUT,
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types",
						">risposta_getStatoAdesioneYG_Type>StatoAdesione"),
				java.lang.String.class, false, false);
		oper.addParameter(param);
		param = new org.apache.axis.description.ParameterDesc(
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "DataStatoAdesione"),
				org.apache.axis.description.ParameterDesc.OUT,
	...
	public ServizicoapWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
		...
		cls = it.eng.sil.coop.webservices.coapadesioneGet.ministero.types.Risposta_getStatoAdesioneYG_TypeEsito.class;
	...
	public void getStatoAdesioneYG(java.lang.String datiStatoAdesione,
		...
		_call.setOperationName(
				new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types", "getStatoAdesioneYG"));
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					esito.value = (it.eng.sil.coop.webservices.coapadesioneGet.ministero.types.Risposta_getStatoAdesioneYG_TypeEsito) _output
							.get(new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types",
									"Esito"));
				} catch (java.lang.Exception _exception) {
					esito.value = (it.eng.sil.coop.webservices.coapadesioneGet.ministero.types.Risposta_getStatoAdesioneYG_TypeEsito) org.apache.axis.utils.JavaUtils
							.convert(
				...
				try {
					dataAdesione.value = (java.util.Date) _output.get(new javax.xml.namespace.QName(
							"http://servizi.lavoro.gov.it/servizicoap/types", "DataAdesione"));
				} catch (java.lang.Exception _exception) {
					dataAdesione.value = (java.util.Date) org.apache.axis.utils.JavaUtils
							.convert(
									_output.get(new javax.xml.namespace.QName(
											"http://servizi.lavoro.gov.it/servizicoap/types", "DataAdesione")),
				...
				try {
					statoAdesione.value = (java.lang.String) _output.get(new javax.xml.namespace.QName(
							"http://servizi.lavoro.gov.it/servizicoap/types", "StatoAdesione"));
				} catch (java.lang.Exception _exception) {
					statoAdesione.value = (java.lang.String) org.apache.axis.utils.JavaUtils
							.convert(
									_output.get(new javax.xml.namespace.QName(
											"http://servizi.lavoro.gov.it/servizicoap/types", "StatoAdesione")),
									java.lang.String.class);
				...
				try {
					dataStatoAdesione.value = (java.util.Calendar) _output.get(new javax.xml.namespace.QName(
							"http://servizi.lavoro.gov.it/servizicoap/types", "DataStatoAdesione"));
				} catch (java.lang.Exception _exception) {
					dataStatoAdesione.value = (java.util.Calendar) org.apache.axis.utils.JavaUtils
							.convert(
									_output.get(new javax.xml.namespace.QName(
											"http://servizi.lavoro.gov.it/servizicoap/types", "DataStatoAdesione")),
