 ...
 * 
 */
public class CMAssociaRichiesteAdesione extends AbstractSimpleModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger
			.getLogger(CMAssociaRichiesteAdesione.class.getName());
	...
	public void service(SourceBean request, SourceBean response) throws EMFInternalError {
		...
		try {
			...
			for (int i = 0; i < prgRosaVector.size(); i++) {
				...
				request.updAttribute("PRGROSA", (String) prgRosaVector.get(i));
				...
				success = insertAdesioneCM(transExec, request, response, (String) prgRosaVector.get(i),
						numMesiAnzianita);
			...
			it.eng.sil.util.TraceWrapper.debug(_logger,
					"CMAssociaRichiesteAdesione::service(): Impossibile inserire l'adesione!", ex);
		...
		try {
			...
			if (!codiceRit.equals("0")) {
				...
				case 4:
					...
					msg = "Inserimento Adesione: errore non è iscritto all'art.8";
					break;
				case 5:
					msgCode = MessageCodes.IDO.ERR_INS_ADESIONE_ART18;
					msg = "Inserimento Adesione: errore non è iscritto all'art.18";
					break;
				case 6:
					msgCode = MessageCodes.IDO.ERR_INS_ADESIONE_NO_REDDITO;
					msg = "Inserimento Adesione: errore non ha dichiarato reddito";
					break;
				case 7:
					msgCode = MessageCodes.IDO.ERR_INS_ADESIONE_NO_DISOC_INOC;
					msg = "Inserimento Adesione: errore non è inoccupato o disoccupato";
					break;
				case 8:
					msgCode = MessageCodes.IDO.ERR_INS_ADESIONE_NO_ESITO;
					msg = "Inserimento Adesione: errore esisto avvii a selezione senza esito";
					break;
				case 9:
					msgCode = MessageCodes.IDO.ERR_INS_ADESIONE_ISEE;
