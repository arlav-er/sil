...
public class ApiConservazioneLSU {
	...
	public ApiConservazioneLSU(SourceBean conf) {
		this.config = conf;
	}
	...
	private void testata(Area area) throws Exception {
		...
		tp = p.addTextPart("Lista Lavoratori Conservazione LSU");
	...
	private void stampaIntestazione(Area ph, Vector rows) throws Exception {
		...
		t = ReportUtils.addText(section, "Azienda", s, 50);
		t.setHeight(600);

		t = ReportUtils.addText(section, "Lavoratore", s, 500);
		t.setHeight(600);

		t = addText(section, "Tipo iscrizione", s, 950);
		t.setHeight(600);

		t = addText(section, "Data inizio iscr.", s, 1400);
		t.setHeight(600);

		t = addText(section, "Data fine iscr.", s, 1700);
		t.setHeight(600);

		t = addText(section, "Data inizio mov.", s, 2000);
		t.setHeight(600);

		t = addText(section, "Data fine mov.", s, 2300);
		t.setHeight(600);
	...
	private void azione(Area details, SourceBean infoAzione) throws Exception {
		...
		String lavoratore = StringUtils.getAttributeStrNotNull(infoAzione, "datiLav");
		String azienda = StringUtils.getAttributeStrNotNull(infoAzione, "datiAz");
		String datInizioIscr = StringUtils.getAttributeStrNotNull(infoAzione, "datInizio");
		String datFineIscr = StringUtils.getAttributeStrNotNull(infoAzione, "datFine");
		String datInizioMov = StringUtils.getAttributeStrNotNull(infoAzione, "datInizioMov");
		String datFineMov = StringUtils.getAttributeStrNotNull(infoAzione, "datFineMov");
		String tipoIscr = StringUtils.getAttributeStrNotNull(infoAzione, "tipoIscr");

		t = addText(section, azienda, 8, 50, 450);
		t.setCanGrow(true);

		t = addText(section, lavoratore, 8, 500, 450);
		t.setCanGrow(true);

		t = addText(section, tipoIscr, 8, 950, 450);
		t.setCanGrow(true);

		t = addText(section, datInizioIscr, 8, 1400, 300);
		t.setCanGrow(true);

		t = addText(section, datFineIscr, 8, 1700, 300);
		t.setCanGrow(true);

		t = addText(section, datInizioMov, 8, 2000, 300);
		t.setCanGrow(true);

		t = addText(section, datFineMov, 8, 2300, 300);
		t.setCanGrow(true);
	}
