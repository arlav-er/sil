 ...
 * 
 */
public class ASRiapriGraduatoria extends AbstractSimpleModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(ASRiapriGraduatoria.class.getName());
	...
	public void service(SourceBean request, SourceBean response) throws EMFInternalError {
		...
		try {
			...
			it.eng.sil.util.TraceWrapper.debug(_logger,
					"ASRiapriGraduatoria::service(): Impossibile riaprire la graduatoria!", ex);
