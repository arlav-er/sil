...
public class DynComboProspetti implements IDynamicStatementProvider2 {

	private String SELECT_STATO_ATTO = " select sa.CODSTATOATTO as codice, sa.STRDESCRIZIONE as descrizione "
			+ " from   de_stato_atto sa, de_stato_atto_lst_tab sat "
			+ " where  sat.CODSTATOATTO = sa.CODSTATOATTO and sat.CODLSTTAB = 'CM_PROSP' ";

	public DynComboProspetti() {
	}
