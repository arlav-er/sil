...
public class AssistErWsSoapBindingSkeleton
	...
	static {
		...
		_oper = new org.apache.axis.description.OperationDesc("getInfoLavoratore", _params,
				new javax.xml.namespace.QName("http://assister.webservices.coop.sil.eng.it",
						"getInfoLavoratoreResponse"));
		_oper.setReturnType(new javax.xml.namespace.QName("http://assister.webservices.coop.sil.eng.it",
				"getInfoLavoratoreResponse"));
	...
	public AssistErWsSoapBindingSkeleton() {
		this.impl = new it.eng.sil.coop.webservices.asl.SpilAslWsSoapBindingImpl();
	}

	public AssistErWsSoapBindingSkeleton(it.eng.sil.coop.webservices.asl.SPILASLWSImpl impl) {
		this.impl = impl;
	}
