...
public class RicercaMansioneCodice implements IDynamicStatementProvider {
	private String className = this.getClass().getName();

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(RicercaMansioneCodice.class.getName());
	...
	public String getStatement(RequestContainer requestContainer, SourceBean config) {
		...
		if (flgIDO != null && flgIDO.equals("S")) {
			...
			query_totale.append(" where man.codMansione like '" + codMansione + "%' ");
