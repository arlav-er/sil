...
public class DeleteEventiCondizionalitaService extends AbstractSimpleModule {
	...
	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger
			.getLogger(DeleteEventiCondizionalitaService.class.getName());

	private String END_POINT = "deleteCondizionalita";
	...
	public static final int ESITO_DEL_OK = 961009;
	...
	public void service(SourceBean serviceRequest, SourceBean serviceResponse) throws Exception {
		...
		try {
			...
			eventiCondizionalitaProxy.deleteEventiCondizionalitaRDC(codiceCpiMin, Cod_evento.fromValue(codEvento),
					cfBeneficiario, cfOperatoreCpi, protocolloInps, DateUtils.getDate(dataDomanda),
					DateUtils.getDate(dataEvento), codEsito, descrEsito);
			...
			if (codEsito.value.equalsIgnoreCase("E100") || codEsito.value.equalsIgnoreCase("OK")) {
				...
				trans.executeQuery("UPDATE_AM_CONDIZIONALITA_CANCELLA_EVENTO",
						new Object[] { userid, userid, new BigDecimal(numKLo), new BigDecimal(prgCondizionalita) },
						"UPDATE");
				// -- COMMIT TRANSAZIONE
				trans.commitTransaction();
				serviceResponse.setAttribute("ESITO_OK", "ESITO_OK");
				serviceResponse.setAttribute("PRGCONDIZIONALITA", prgCondizionalita);
				reportOperation.reportSuccess(ESITO_DEL_OK);
