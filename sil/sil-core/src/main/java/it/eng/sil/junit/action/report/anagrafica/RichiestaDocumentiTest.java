 ...
 * 
 */
public class RichiestaDocumentiTest extends TestCase {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(RichiestaDocumentiTest.class.getName());

	/**
	 * semplice generazione del report in modalita' sola visione. Questo test e' comodo per testare modifiche al report,
	 * dato che per arrivare a stamparlo da applicativo bisogna seguire un percorso lungo (il trasferimento/presa atto
	 * di un lavoratore)
	 */
	...
	void setRequest(SourceBean serviceRequest) throws SourceBeanException {
		...
		serviceRequest.setAttribute("tipoDoc", "TRDOC");
	...
	public static void main(String[] args) {
		junit.swingui.TestRunner.run(RichiestaDocumentiTest.class);
	}
}