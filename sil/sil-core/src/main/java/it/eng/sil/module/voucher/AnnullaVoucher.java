...
public class AnnullaVoucher extends AbstractSimpleModule {

	private static final long serialVersionUID = -1533726811526662058L;
	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(AnnullaVoucher.class.getName());
	...
	public void service(SourceBean request, SourceBean response) throws Exception {
		...
		String strCodMotivoAnnullamento = StringUtils.getAttributeStrNotNull(request, "codAnnullamento");
		...
		try {
			...
			Integer esito = vch.annulla(conn, cdnParUtente, strCodMotivoAnnullamento);
			...
			if (esito.intValue() == 0) {
				...
				case Properties.ERRORE_STATO_VCH_ANNULLA:
