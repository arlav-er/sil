 ...
 *         Finestra&gt;Preferenze&gt;Java&gt;Generazione codice&gt;Codice e commenti
 */
public class UpdateAssunz extends AbstractSimpleModule {
	public void service(SourceBean request, SourceBean response) throws Exception {
		...
		try {
			...
			this.setSectionQueryUpdate("QUERY_UPDATE_ASS");
			ret = doUpdate(request, response);

			if (!ret) {
				throw new Exception("impossibile aggiornare in CM_CONV_DETTAGLIO in transazione");
			}
