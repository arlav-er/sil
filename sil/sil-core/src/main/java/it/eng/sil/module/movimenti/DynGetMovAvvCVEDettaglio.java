 ...
 *         Finestra&gt;Preferenze&gt;Java&gt;Generazione codice&gt;Codice e commenti
 */
public class DynGetMovAvvCVEDettaglio implements IDynamicStatementProvider {
	...
	private String SELECT_PROLOGO = "SELECT TO_CHAR(PRGMOVIMENTOAPP) PRGMOVIMENTOAPP, "
			...
			+ "CODAZATECO codAtecoUAz, ATTUAZ.STRDESCRIZIONE descrAtecoUAz, "
			+ "CODAZCCNL codCCNLAz, COLL.STRDESCRIZIONE descrCCNLAz, "
			+ "TO_CHAR(NUMAZDIPENDENTI) NUMDIPENDENTIAz, STRUAINDIRIZZO strIndirizzoUAz, "
			+ "CODUACOM codComuneUAz, STRUACAP strCapUAz, STRUATEL strTelUAz, STRUAFAX strFaxUAz, "
			...
			+ "TO_CHAR(DATINIZIOMOV, 'DD/MM/YYYY') DATINIZIOMOV, " + "CODTIPOMOV, MOV.CODMANSIONE, STRDESATTIVITA, "
			+ "MOV.CODCONTRATTO, CODMONOTEMPO, FLGSOCIO, MOV.CODCCNL, "
			+ "TO_CHAR(DECRETRIBUZIONEMEN) DECRETRIBUZIONEMEN, " + "TO_CHAR(DECRETRIBUZIONEANN) DECRETRIBUZIONEANN, "
			...
			+ "decode(MOV.CODTIPOMOV,'CES','',TO_CHAR(DATFINEMOV, 'DD/MM/YYYY')) DATFINEMOV, " + "MOV.STRNOTE, "
			+ "TO_CHAR(CDNUTINS) CDNUTINS, TO_CHAR(DTMINS, 'DD/MM/YYYY') DTMINS, "
			+ "TO_CHAR(CDNUTMOD) CDNUTMOD, TO_CHAR(DTMMOD, 'DD/MM/YYYY') DTMMOD, "
			+ "TO_CHAR(NUMKLOMOVAPP) NUMKLOMOVAPP, " + "STRMATRICOLA, " + "MOV.CODTIPOCONTRATTO CODTIPOASS, "
			+ "CODNORMATIVA, CODGRADO, FLGARTIGIANA, " + "TO_CHAR(DATCFL, 'DD/MM/YYYY') DATCFL, STRNUMCFL, STRTIPOCFL, "
			...
			+ "TO_CHAR(MOV.DATAZINTFINECONTRATTO, 'DD/MM/YYYY') DATAZINTFINECONTRATTO, " + "MOV.STRAZINTRAP, "
			+ "MOV.CODAZINTATECO CODAZINTATECO, " + "ATTUAZUTIL.STRDESCRIZIONE descrAtecoUAzUtil, "
			...
			+ "TIPOASS.CODMONOTIPO codmonotipo, " + "TO_CHAR(MOV.NUMGGPREVISTIAGR)  NUMGGPREVISTIAGR, "
			...
			+ "MOV.STRCODICEFISCALEAZPREC, MOV.CODCOMAZPREC, " + "MOV.STRINDIRIZZOAZPREC, MOV.STRRAGIONESOCIALEAZPREC, "
			...
			+ "MOV.FLGSISTEMAZIONEALLOGGIATIVA, MOV.FLGPAGAMENTORIMPATRIO, MOV.FLGAZUTILIZESTERA, MOV.STRNUMAGSOMMINISTRAZIONE, "
			...
			+ "MOV.FLGLAVOROINMOBILITA, MOV.FLGLAVOROSTAGIONALE, MOV.STRCODFISCPROMOTORETIR, " + "MOV.STRTRACCIATO ";
	...
	private String SELECT_EPILOGO = "DE_CONTRATTO_COLLETTIVO COLL, " + "DE_CONTRATTO_COLLETTIVO DE_CCNL, "
			...
			+ "DE_PROVINCIA PROV, " + "DE_PROVINCIA PROVLAV, " + "DE_TIPO_CONTRATTO TIPOASS, "
			+ "DE_CITTADINANZA CITT, " + "DE_CPI CPILAV, " + "DE_MANSIONE MANS, " + "DE_MANSIONE TIPOMANS, "
			+ "DE_TIPO_AZIENDA TIPOAZ, " + "DE_ATTIVITA ATTUAZ, " + "DE_ATTIVITA ATTUAZUTIL, "
			+ "DE_QUALIFICA_SRQ QUALSRQ, " + "DE_TIPO_TRASF, " + "DE_ENTE_PREVIDENZIALE ENTE "
			+ "WHERE MOV.CODUACOM = COMUAZ.CODCOM (+) " + "AND MOV.CODUAINTCOM = COMUAZUTIL.CODCOM (+) "
			+ "AND MOV.CODCOMNASC = COMNASCLAV.CODCOM (+) " + "AND MOV.CODCOMDOM = COMDOMLAV.CODCOM (+) "
	...
	public DynGetMovAvvCVEDettaglio() {
	}

	public String getStatement(RequestContainer requestContainer, SourceBean config) {
		SourceBean req = requestContainer.getServiceRequest();
		String prgMovimentoApp = Utils.notNull(req.getAttribute("prgMovimentoAppCVE"));
		String context = "";
