...
public class StampaListaConservazioneLSU extends AbstractSimpleReport {
	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger
			.getLogger(StampaListaConservazioneLSU.class.getName());
	...
	public void service(SourceBean request, SourceBean response) {
		...
		if (apriFile != null && apriFile.equalsIgnoreCase("true")) {
			...
			if (tipoFile != null)
				setStrNomeDoc("ListaConservazioneLSU." + tipoFile);
			else
				setStrNomeDoc("ListaConservazioneLSU.pdf");

			setStrDescrizione("Lista Lavoratori Conservazione LSU");
			setReportPath("iscrizioni/ListaConservazioneLSU_CC.rpt");
