...
public class Ricevuta extends AbstractSimpleReport {
	...
	public void service(SourceBean request, SourceBean response) {
		...
		if (apriFile != null && apriFile.equalsIgnoreCase("true")) {
			...
			try {
				setStrDescrizione("Ricevuta lavoratore");

				String tipoFile = (String) request.getAttribute("tipoFile");
				if (tipoFile != null)
					setStrNomeDoc("RicevutaLavoratore." + tipoFile);
				else
					setStrNomeDoc("RicevutaLavoratore.pdf");

				setReportPath("Amministrazione/Ricevuta_CC.rpt");
				...
				reportFailure(ue, "Ricevuta.service()", "");
			}
		} // else
	}
}