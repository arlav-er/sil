...
public class CercaComune_Precisa extends AbstractModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(CercaComune_Precisa.class.getName());
