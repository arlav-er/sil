...
public class AccettazionePattoType implements java.io.Serializable {
	...
	private it.eng.sil.coop.webservices.pattoonline.AccettazionePattoTypeTipoAccettazione tipoAccettazione;

	public AccettazionePattoType() {
	}

	public AccettazionePattoType(java.util.Calendar dtmAccettazione,
			it.eng.sil.coop.webservices.pattoonline.AccettazionePattoTypeTipoAccettazione tipoAccettazione) {
	 ...
	 */
	public it.eng.sil.coop.webservices.pattoonline.AccettazionePattoTypeTipoAccettazione getTipoAccettazione() {
		return tipoAccettazione;
	}
	...
	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("http://pattoonline.webservices.coop.sil.eng.it/",
				"AccettazionePattoType"));
		org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
		elemField.setFieldName("dtmAccettazione");
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://pattoonline.webservices.coop.sil.eng.it/", "DtmAccettazione"));
		...
		elemField.setXmlName(
				new javax.xml.namespace.QName("http://pattoonline.webservices.coop.sil.eng.it/", "TipoAccettazione"));
