 ...
 */
public class AggiornaCompetenzaIRMessage extends AbstractMessage implements IFaceMessage {
	...
	private String datTrasferimento = null;
	...
	public AggiornaCompetenzaIRMessage() {
	...
	public void setObjectMessage(ObjectMessage msg) throws Exception {
		...
		try {
			...
			testata.setServizio("AggiornaCompetenzaIR");
		...
		try {
			...
			datTrasferimento = (String) appParam.get(4);
			cognome = (String) appParam.get(5);
			nome = (String) appParam.get(6);
			datNasc = (String) appParam.get(7);
			codComNas = (String) appParam.get(8);
		} catch (Exception ex) {
	...
	public void setServiceParameters(Map par) {
		...
		datTrasferimento = (String) serviceParam.get("datTrasferimento");
	...
	public void callWebservice() throws Exception {
		 ...
		 * service.aggiornaCompetenzaIR(codiceFiscale, codCpi, codMonoTipoCpi, cpiComp, datTrasferimento, cognome, nome,
		 * datNasc, codComNas, testata.getCdnGruppo(), testata.getCdnProfilo(), testata.getStrMittente(),
		...
		param.put("datTrasferimento", datTrasferimento);
	 ...
	 * @param string
	 */
	public void setdatTrasferimento(String string) {
		datTrasferimento = string;
	}
