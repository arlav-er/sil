...
public class StampaU010 extends AbstractSimpleReport {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(StampaU010.class.getName());

	private static final long serialVersionUID = 9015433517028506547L;

	private static String reportDescription = "U010";
	private static String reportRelativePath = "Amministrazione/StampaU010_UMB_CC.rpt";
	private static String reportOutputFileName = "U010";
