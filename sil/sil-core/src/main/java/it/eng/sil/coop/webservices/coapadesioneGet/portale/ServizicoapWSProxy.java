...
public class ServizicoapWSProxy implements it.eng.sil.coop.webservices.coapadesioneGet.portale.ServizicoapWS {
	private String _endpoint = null;
	private it.eng.sil.coop.webservices.coapadesioneGet.portale.ServizicoapWS servizicoapWS = null;
	...
	private void _initServizicoapWSProxy() {
		try {
			servizicoapWS = (new it.eng.sil.coop.webservices.coapadesioneGet.portale.GetStatoAdesioneYGLocator())
					.getGetStatoAdesioneYG();
	...
	public it.eng.sil.coop.webservices.coapadesioneGet.portale.ServizicoapWS getServizicoapWS() {
		if (servizicoapWS == null)
			_initServizicoapWSProxy();
