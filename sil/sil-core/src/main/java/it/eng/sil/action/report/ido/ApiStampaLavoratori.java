...
public class ApiStampaLavoratori {
	...
	private String etaMaggiore = null;
	private String etaUguale = null;
	...
	public ApiStampaLavoratori(SourceBean conf) {
		this.config = conf;
	}
	...
	public void start() throws Exception {
		try {
			...
			eng.setReportTitle("Elenco Lavoratori");
	...
	private void testata(Area area) throws Exception {
		...
		if (eta.equals("maggiore")) {
			...
			p.setHeight(0);
			tp = p.addTextPart(
					"Lavoratori iscritti al collocamento mirato con età superiore a " + etaMaggiore + " anni ");
			s.setStyle(tp);
			tp.setFontSize(12);
			tp.setFontName("Times New Roman");
			tp.setBold(true);
			...
			p = text.addParagraph();
			p.setHeight(0);
			tp = p.addTextPart("Lavoratori iscritti al collocamento mirato con età uguale a " + etaUguale + " anni ");
			s.setStyle(tp);
			tp.setFontSize(12);
			tp.setFontName("Times New Roman");
			tp.setBold(true);
	...
	public String getEtaMaggiore() {
		return etaMaggiore;
	}

	public String getEtaUguale() {
		return etaUguale;
	}
	...
	public void setEtaMaggiore(String string) {
		etaMaggiore = string;
	}

	public void setEtaUguale(String string) {
		etaUguale = string;
	}
