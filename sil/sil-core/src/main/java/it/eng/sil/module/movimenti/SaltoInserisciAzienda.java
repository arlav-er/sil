...
public class SaltoInserisciAzienda extends AbstractModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(SaltoInserisciAzienda.class.getName());
	...
	public void service(SourceBean request, SourceBean response) {
		...
		try {
			...
			for (int iList = 0; iList < myGoToes.size(); iList++) {
				...
				if (strPageTarget.compareTo("IDOTESTATAAZIENDAPAGE") == 0) {
					SourceBean row = new SourceBean("ROW");
					row.setAttribute("GOPAGE", strPageTarget);
