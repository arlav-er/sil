...
public class RegistraIscrizioneCIGMessage extends AbstractMessage implements IFaceMessage {

	private String XMLMessage;
	private final int maxRedeliveries = 10;
	private static final Logger log = Logger.getLogger(RegistraIscrizioneCIGMessage.class.getName());
