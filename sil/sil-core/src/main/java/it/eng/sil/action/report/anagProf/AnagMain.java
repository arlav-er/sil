...
public class AnagMain extends AbstractSimpleReport {
	...
	public void service(SourceBean request, SourceBean response) {
		...
		if (apriFile != null && apriFile.equalsIgnoreCase("true")) {
			...
			try {
				...
				if (tipoFile != null)
					setStrNomeDoc("AnagraficaPrincipaleLavoratore." + tipoFile);
				else
					setStrNomeDoc("AnagraficaPrincipaleLavoratore.pdf");

				setStrDescrizione("Scheda anagrafica professionale");
				setReportPath("AnagProf/AnagProfessionale_CC.rpt");
				...
				reportFailure(ue, "AnagMain.service()", "");
			}
		} // else
	}
}
