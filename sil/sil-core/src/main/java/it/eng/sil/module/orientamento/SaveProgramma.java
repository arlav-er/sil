...
public class SaveProgramma extends AbstractSimpleModule {
	public void service(SourceBean request, SourceBean response) throws Exception {
		...
		try {
			...
			this.setSectionQueryUpdate("QUERY_UPDATE_PROGRAMMI");
			ret = doUpdate(request, response);

			if (!ret) {
				throw new Exception("impossibile aggiornare CM_LAV_REDDITO in transazione");
			}
