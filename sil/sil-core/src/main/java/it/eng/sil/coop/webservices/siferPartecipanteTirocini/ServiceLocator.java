...
public class ServiceLocator extends org.apache.axis.client.Service
		implements it.eng.sil.coop.webservices.siferPartecipanteTirocini.Service {
	...
	public it.eng.sil.coop.webservices.siferPartecipanteTirocini.PortType getrequestService()
			throws javax.xml.rpc.ServiceException {
	...
	public it.eng.sil.coop.webservices.siferPartecipanteTirocini.PortType getrequestService(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			it.eng.sil.coop.webservices.siferPartecipanteTirocini.BindingStub _stub = new it.eng.sil.coop.webservices.siferPartecipanteTirocini.BindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (it.eng.sil.coop.webservices.siferPartecipanteTirocini.PortType.class
