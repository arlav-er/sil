...
public class LoginResponse implements java.io.Serializable {
	private LoginRet loginResult;

	public LoginResponse() {
	}

	public LoginResponse(LoginRet loginResult) {
	 ...
	 * @param loginResult
	 */
	public void setLoginResult(LoginRet loginResult) {
		this.loginResult = loginResult;
	}
	...
	static {
		...
		elemField.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", "LoginRet"));
