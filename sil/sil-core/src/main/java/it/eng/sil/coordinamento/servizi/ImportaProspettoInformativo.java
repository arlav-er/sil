 ...
 * @author savino
 */
public class ImportaProspettoInformativo implements ServizioSoap {

	private static Logger logger = Logger.getLogger(ImportaProspettoInformativo.class);

	public String elabora(Execute parametri) {
		String risultato = null;
		TransactionQueryExecutor tex = null;
		String serviceName = "RegistraProspettoInformativo";
		String prospettoXML = parametri.getDati();
		Map param = new HashMap();

		param.put("servizio", "RegistraProspettoInformativo");
		param.put("dati_xml", prospettoXML);
