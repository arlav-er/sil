...
public class ServizicoapWSSoapBindingStub extends org.apache.axis.client.Stub
		implements it.eng.sil.coop.webservices.coapadesioneSet.ministero.ServizicoapWS {
	...
	private static void _initOperationDesc1() {
		...
		param = new org.apache.axis.description.ParameterDesc(
				...
				it.eng.sil.coop.webservices.coapadesioneSet.ministero.types.Risposta_setStatoAdesioneYG_TypeEsito.class,
				false, false);
		oper.addParameter(param);
		param = new org.apache.axis.description.ParameterDesc(
	...
	public ServizicoapWSSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
		...
		cls = it.eng.sil.coop.webservices.coapadesioneSet.ministero.types.Risposta_setStatoAdesioneYG_TypeEsito.class;
	...
	public void setStatoAdesioneYG(java.lang.String datiStatoAdesione,
		...
		try {
			...
			if (_resp instanceof java.rmi.RemoteException) {
				...
				try {
					esito.value = (it.eng.sil.coop.webservices.coapadesioneSet.ministero.types.Risposta_setStatoAdesioneYG_TypeEsito) _output
							.get(new javax.xml.namespace.QName("http://servizi.lavoro.gov.it/servizicoap/types",
									"Esito"));
				} catch (java.lang.Exception _exception) {
					esito.value = (it.eng.sil.coop.webservices.coapadesioneSet.ministero.types.Risposta_setStatoAdesioneYG_TypeEsito) org.apache.axis.utils.JavaUtils
							.convert(
