...
public class DichMesiSucc extends AbstractSimpleReport {
	...
	public void service(SourceBean request, SourceBean response) {
		...
		if (apriFile != null && apriFile.equalsIgnoreCase("true")) {
			...
			try {
				setStrDescrizione("Dichiarazione Mesi Successivi - Erogazione Indennità regionale");

				String tipoFile = (String) request.getAttribute("tipoFile");
				if (tipoFile != null)
					setStrNomeDoc("DichMesiSucc." + tipoFile);
				else
					setStrNomeDoc("DichMesiSucc.pdf");

				setReportPath("Amministrazione/MesiSucc_CC.rpt");
