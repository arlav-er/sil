...
public class CercaCCNL_Precisa extends AbstractModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(CercaCCNL_Precisa.class.getName());
