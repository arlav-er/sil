...
public class GetDescCorsi extends AbstractModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(GetDescCorsi.class.getName());
	...
	public void service(SourceBean request, SourceBean response) {
		...
		try {
			...
			it.eng.sil.util.TraceWrapper.fatal(_logger, className
					+ "::select: response.setAttribute((SourceBean)rowObject)", ex);
