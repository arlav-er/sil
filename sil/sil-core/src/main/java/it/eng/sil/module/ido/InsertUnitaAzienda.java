...
public class InsertUnitaAzienda extends AbstractSimpleModule {

	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(InsertUnitaAzienda.class.getName());
		...
		if (!unitaPresente) {
			try {
				...
				it.eng.sil.util.TraceWrapper.debug(_logger,
						"InsertUnitaAzienda::service(): Impossibile inserire l'unita aziendale!", ex);
