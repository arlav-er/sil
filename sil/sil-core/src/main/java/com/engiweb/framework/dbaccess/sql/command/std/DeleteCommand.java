...
public class DeleteCommand extends SQLCommand {
	...
	static org.apache.log4j.Logger _logger = org.apache.log4j.Logger.getLogger(DeleteCommand.class.getName());
	 ...
	 */
	public DeleteCommand(DataConnection dataConnection, String commandString) {
		super(dataConnection, commandString);
	} // public DeleteCommand(DataConnection dataConnection, String
		// commandString)
	...
	public DataResult execute() throws EMFInternalError {
		...
		// "model.data-access.delete." + _commandString.toLowerCase());
		try {
			this.closeInternal();
			...
			it.eng.sil.util.TraceWrapper.fatal(_logger, "DeleteCommand::execute:", sqle);

			String method = "DeleteCommand :: execute() ::";
	...
	public DataResult execute(List inputParameters) throws EMFInternalError {
		...
		try {
			...
			String method = "DeleteCommand :: execute(inputParameters) :: ";
			throw Utils.generateInternalError(sqle, method);
		} // catch (SQLException sqle) try
			// finally {
			// monitor.stop();
