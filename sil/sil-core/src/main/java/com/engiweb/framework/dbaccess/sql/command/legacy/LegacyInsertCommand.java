 ...
 * @version 1.0
 */
public class LegacyInsertCommand extends SQLCommand {
	/**
	 * Costruttore
	 * 
	 ...
	 */
	public LegacyInsertCommand(DataConnection dataConnection, String commandString) {
		super(dataConnection, commandString);
	} // public LegacyInsertCommand(DataConnection dataConnection, String
		// commandString)
