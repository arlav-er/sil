...
public class LegacyUpdateCommand extends SQLCommand {
	 ...
	 */
	public LegacyUpdateCommand(DataConnection dataConnection, String commandString) {
		super(dataConnection, commandString);
	} // public LegacyUpdateCommand(DataConnection dataConnection, String
		// commandString)
