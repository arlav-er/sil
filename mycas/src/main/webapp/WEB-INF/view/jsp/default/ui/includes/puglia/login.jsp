...
<section class="main-content">
	<div id="content" class="row">
		...
		<h2 class="page-title">Lavoro per Te Puglia</h2>
		<div id="logo_lavoro_per_te" class="col-md-8">
			<div class="paragraph">
				<div>È il portale di servizi della Regione Puglia, realizzato in collaborazione con le Province e i Centri per
					l'Impiego per rendere piú semplice l'incontro fra chi offre e chi cerca lavoro.</div>
				<div>
			...
			<div class="row">
				<div class="col-md-12">
					<h2 class="page-title black m-t-40">Collegamenti a SINTESI</h2>
					<jsp:directive.include file="pugliaMap.jsp" />
				</div>
			</div>
			...
			<div class="paragraph">
				<div>
					...
					<br />
					<a href="mailto:accountlavoroxte@regione.puglia.it" class="red-link">accountlavoroxte@regione.puglia.it</a>
				</div>
				<div>
					INDICARE:
					<br />
			...
			<div id="fed-umbria-container" class="top-buffer">
				<div id="fed-umbria">
					...
					<div class="top-small-buffer">
						<label>
							<a style="color: #000"
								href="<%=myportalAddress%>/SPID/PugliaLogin?loginTicket=${loginTicket}&flowExecutionKey=${flowExecutionKey}">
								Login con SPID </a>
						</label>
					</div>
				</div>
...
<script type="text/javascript" src="js/puglia-map.js"></script>
