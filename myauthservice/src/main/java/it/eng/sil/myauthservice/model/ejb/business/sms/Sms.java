...
public class Sms {
	...
	public Sms(String _cellNumber, String _text, int _maxLength) throws SmsFormatException {
		...
		if (cellNumber.length() < 3)
			throw new SmsFormatException(SmsFormatException.ERR_N_CELL_NON_VALIDO, "Numero di cellulare <" + cellNumber
					+ "> troppo corto");
	...
	public Sms(String _cellNumber, String _text) throws SmsFormatException{
		cellNumber = _cellNumber;
		text = _text;
